...
<div class="container my-5">
    <div class="row aproduct-card" id="home_cushioncover_p16">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="../../../productimgs/home/cushioncover/p16/main.jpg" class="product-link">
                 <img src="../../../productimgs/home/cushioncover/p16/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/cushioncover/p16/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p16/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p16/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p16/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/home/cushioncover/p16/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p16/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p16/6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Snowflake Cotton Cushion Covers (Set of 2)</h2>
            <p class="mt-3 aproduct-description">Festive red & white throw pillows with pom-pom lace.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 299/ Pack</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹499</del></span></span>  <br>
    ...
    <li><b>Product Dimensions:</b> 50L x 50W Centimeters</li>
...
<div style="text-align:justify;">
    ...
    <ul>
        <li><b>100% Pure Cotton Comfort:</b> Crafted from premium cotton for softness, breathability, and long-lasting durability.</li>
        <li><b>Easy to Clean:</b> Machine washable for convenient maintenance.</li>
        <li><b>Thoughtful Gift Idea:</b> Ideal for Christmas and New Year gifting or as a festive housewarming present.</li>
        <li><b>Hidden Zipper Closure:</b> Yes</li>
        <li><b>Festive Red & White Design:</b> Features classic holiday colors with pom-pom lace and snowflake accents for Christmas charm.</li>
        <li><b>Elegant Holiday Decor:</b> Enhances Christmas, New Year, and winter gatherings with cozy sophistication.</li>
        <li><b>Perfect 20x20 Size:</b> Fits standard throw pillows, ideal for sofas, beds, chairs, and festive decor.</li>
    </ul>
</div>
