...
<div class="container my-5">
    <div class="row aproduct-card" id="home_tablerunner_p7">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p7.php" class="product-link">
                 <img src="../../../productimgs/home/tablerunner/p7/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/tablerunner/p7/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p7/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p7/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p7/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p7/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p7/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p7/6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Peach Cotton Table Runner</h2>
            <p class="mt-3 aproduct-description">Aesthetic & washable, perfect for dining & living spaces.<br> 
                ...
                <span><b>Size:</b> 59x16 inches</span>
            </p>
...
<div style="text-align:justify;">
    ...
    <ul>
        <li><b>100% Pure Cotton Material:</b> Soft, durable, and eco-friendly for a stylish yet practical decor piece.</li>
        <li><b>Perfect Fit for 4-Seater Tables:</b> Sized at 59x16 inches, ideal for coffee and dining tables.</li>
        <li><b>Elegant Peach Hue:</b> Adds a sophisticated aesthetic to dining rooms, coffee tables, and living rooms.</li>
        <li><b>Washable & Easy to Maintain:</b> Machine washable for effortless care, retaining color and texture over time.</li>
        <li><b>Multipurpose Use:</b> Ideal for dining tables, coffee tables, and entryway tables, enhancing any room's decor.</li>
        <li><b>Modern & Versatile Design:</b> Complements various decor styles, perfect for home or restaurant use.</li>
        <li><b>Stylish Protection for Surfaces:</b> Helps prevent scratches and spills while adding a touch of elegance.</li>
        <li><b>Eco-Friendly Choice:</b> Crafted from natural cotton for a sustainable, quality decor solution.</li>
    </ul>
</div>
