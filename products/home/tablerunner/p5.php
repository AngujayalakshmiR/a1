...
<div class="container my-5">
    <div class="row aproduct-card" id="home_tablerunner_p5">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p5.php" class="product-link">
                 <img src="../../../productimgs/home/tablerunner/p5/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/tablerunner/p5/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p5/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p5/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p5/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p5/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p5/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <!-- <img src="../../../productimgs/home/tablerunner/p3/6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p3/7.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;"> -->
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Blue Blossom Cotton Table Runner</h2>
            <p class="mt-3 aproduct-description">Floral, nature-inspired, washable & durable.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 299/ Peice</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹599</del></span></span>  <br>
                <span><b>Weight:</b> 250g/peice</span><br>
                <span><b>Size:</b> 72x14 inches</span>
            </p>
    ...
    <li><b>Pattern:</b>Floral</li>
</ul>
<div style="text-align:justify;">
    <h4>About this item</h4>
    <ul>
        <li><b>Premium 100% Cotton Quality:</b> Crafted from pure, breathable cotton fabric, this table runner ensures durability, elegance, and a soft texture.</li>
        <li><b>Elegant Floral Design in Blue:</b> Features a nature-inspired floral print that adds a refreshing touch of sophistication to your dining table or coffee table.</li>
        <li><b>Perfect for 6-Seater Tables:</b> Generously sized at 72 x 14 inches to fit standard 6-seater dining tables, coffee tables, or foyer decor.</li>
        <li><b>Festive & Everyday Charm:</b> Ideal for holiday celebrations, festive dinners, casual gatherings, and enhancing your everyday home decor.</li>
        <li><b>Easy Maintenance & Machine Washable:</b> Designed for hassle-free cleaning, simply toss it in the machine for a quick refresh.</li>
        <li><b>Non-Slip Durable Design:</b> Thick cotton construction ensures the runner stays securely in place, even during large meals or festive events.</li>
        <li><b>Versatile Home Accent:</b> Adds a warm, decorative touch to dining rooms, living rooms, and even outdoor spaces, perfect for special occasions or year-round decor.</li>
        <li><b>Ideal Gift for Any Occasion:</b> A thoughtful gift for housewarming parties, weddings, or festive gifting during Christmas and New Year.</li>
    </ul>
</div>
