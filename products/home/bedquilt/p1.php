...
<div class="container my-5">
    <div class="row aproduct-card" id="home_bedquilt_p1">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p1.php" class="product-link">
                 <img src="../../../productimgs\home\bedquilt\p1\main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs\home\bedquilt\p1\main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                
                <img src="../../../productimgs\home\bedquilt\p1\1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs\home\bedquilt\p1\2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs\home\bedquilt\p1\3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs\home\bedquilt\p1\4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs\home\bedquilt\p1\5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs\home\bedquilt\p1\6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs\home\bedquilt\p1\7.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Reversible Double Bed Quilt Comforter</h2>
            <p class="mt-3 aproduct-description">Cozy, breathable, all-season cotton satin double bed quilt.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 1599/ Piece </b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹3499</del></span></span>  <br>
                <span><b>Weight:</b> 4000g/peice</span><br>
                <span><b>Size:</b> 90x100 inches</span>
            </p>
    ...
    <li><b>Colour:</b> Blue Brown</li>
    <li><b>Special Feature:</b> Breathable</li>
    <li><b>Style:</b> Cottage</li>
    <li><b>Blanket Form:</b> Quilt</li>
    <li><b>Age Range (Description):</b> Adult</li>
    <li><b>Product Dimensions:</b> 2.54L x 2.28W Meters</li>
    <li><b>Pattern:</b> Solid</li>
    <li><b>Recommended Uses For Product:</b> Quilt Blanket, AC Blanket, Winter Blanket</li>
</ul>

<div style="text-align:justify;">
    <h4>About this item</h4>
    <li><b>Material:</b> Satin Cotton, 250 GSM.</li>
    <li><b>Size:</b> Double Bed, 90x100 Inches (228x254 cm).</li>
    <li><b>Design:</b> Reversible, Blue & Brown.</li>
    <li><b>Features:</b> Cozy, Soft, Breathable, Skin-Friendly.</li>
    <li><b>Comforters For Winter:</b> Ideal for chilly winter nights, providing cozy warmth and comfort.</li>
    <li><b>AC Comforter:</b> Perfect for use in air-conditioned rooms, maintaining a comfortable temperature without overheating.</li>
</div>
