...
<div class="container my-5">
    <div class="row aproduct-card" id="home_cushioncover_p6">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="../../../productimgs/home/cushioncover/p6/main.jpg" class="product-link">
                 <img src="../../../productimgs/home/cushioncover/p6/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/cushioncover/p6/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p6/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p6/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p6/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p6/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/home/cushioncover/p6/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/home/cushioncover/p6/6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/home/cushioncover/p6/7.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Christmas Decorative Cushion Covers (Pack of 2)</h2>
            <p class="mt-3 aproduct-description">Festive-themed cotton throw pillow covers, perfect for sofa, bed & home decor.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 299/ Pack</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹699</del></span></span>  <br>
            ...
            <br><br>
            <ul>
    <li><b>Pattern:</b> Print</li>
    <li><b>Material:</b> Cotton</li>
    <li><b>Colour:</b> Multi Colour</li>
    <li><b>Product Dimensions:</b> 45L x 45W Centimeters</li>
    <li><b>Style:</b> Indian</li>
</ul>

<div style="text-align:justify;">
    <h4>About this item</h4>
    <ul>
        <li><b>Premium Cotton Fabric:</b> Crafted from 100% cotton, offering durability, softness, and breathability, perfect for festive and everyday use.</li>
        <li><b>Christmas-Themed Prints:</b> Features charming Christmas tree, star, and snowman elements, ideal for creating a festive atmosphere in your home.</li>
        <li><b>Versatile 18x18 Inches Size:</b> Perfect fit for most standard throw pillows, adding a festive touch to sofas, beds, or chairs.</li>
        <li><b>Vibrant Colors for Festive Cheer:</b> Multicolor design complements your Christmas decor, creating a cozy and inviting ambiance.</li>
        <li><b>Durable & Washable:</b> Machine washable for effortless cleaning, retaining vibrant prints and softness even after multiple washes.</li>
        <li><b>Perfect for Xmas Gifts:</b> A thoughtful and practical gift option for Christmas, housewarming parties, or holiday exchanges.</li>
    </ul>
</div>
