...
<div class="container my-5">
    <div class="row aproduct-card" id="baby_swaddles_p9">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p9.php" class="product-link">
                 <img src="../../../productimgs/baby/swaddle/p9/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/baby/swaddle/p9/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                
                <img src="../../../productimgs/baby/swaddle/p9/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p9/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p9/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p9/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p9/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/baby/swaddle/p9/6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/baby/swaddle/p9/7.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Organic Muslin Baby Wipes – 12 Pack</h2>
            <p class="mt-3 aproduct-description">Soft, absorbent, reusable 10x10" wipes.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 249/ Set </b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹499</del></span></span>  <br>
                <span><b>Weight:</b> 500g/peice</span><br>
                <span><b>Size:</b>0 to 3 years</span>
            </p>
...
<ul>
    ...
    <li><b>Product Dimensions:</b> 25.4L x 25.4W Centimeters</li>
    <li><b>Number of Items:</b> 12</li>
    <li><b>Special Feature:</b> Skin Friendly, Super Absorbent, Lightweight, Washable, Super Soft</li>
    <li><b>Product Care Instructions:</b> Machine Wash</li>
    <li><b>Shape:</b> Square</li>
    <li><b>Seasons:</b> All</li>
    <li><b>Style:</b> Modern</li>
    <li><b>Pattern:</b> Animal Print, Sky Print, Vehicle Print</li>
</ul>


<div style="text-align:justify;">
    <h4>About this item</h4>
    <li><b>Soft & Gentle:</b> Made from 100% organic muslin cotton, perfect for sensitive baby skin.</li>
    <li><b>Adorable Prints:</b> Features cute animal, sky, and moon designs that babies and parents will love.</li>
    <li><b>Highly Absorbent:</b> Keeps your baby dry and comfortable during feeding and diaper changes.</li>
    <li><b>Washable & Reusable:</b> Durable and eco-friendly, these wipes can be washed and reused multiple times.</li>
    <li><b>Convenient Size:</b> 10x10 inches, perfect for various uses such as feeding, bathing, and cleaning.</li>
</div>
