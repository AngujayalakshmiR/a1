...
<div class="container my-5">
    <div class="row aproduct-card" id="home_travelpouch_p1">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p1.php" class="product-link">
                 <img src="../../../productimgs\home\travelpouch\p1\main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs\home\travelpouch\p1\main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                
                <img src="../../../productimgs\home\travelpouch\p1\1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs\home\travelpouch\p1\2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs\home\travelpouch\p1\3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs\home\travelpouch\p1\4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs\home\travelpouch\p1\5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs\home\travelpouch\p1\6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs\home\travelpouch\p1\7.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <div class="col-md-6 " >
            ...
            <p class="mt-3 aproduct-description">Portable grooming organizer for makeup, brushes & essentials.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 249/ Piece </b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹599</del></span></span>  <br>
...
<div style="text-align:justify;">
    ...
    <li><b>Premium Quality Material:</b> Made from durable, lightweight fabric that resists wear and tear, ensuring long-lasting use.</li>
    <li><b>Spacious & Compact Design:</b> With dimensions of 11x6.5x7 inches, it provides ample space for makeup, toiletries, and travel essentials.</li>
    <li><b>Versatile Storage:</b> Perfect for storing cosmetics, grooming tools, toiletries, and daily essentials for women and men.</li>
    <li><b>Set of 2 Pouches:</b> Includes two matching yellow pouches for easy organization of different items while traveling or at home.</li>
    <li><b>Portable & Lightweight:</b> Designed for hassle-free travel, fits perfectly in your luggage, backpack, or handbag.</li>
</div>
