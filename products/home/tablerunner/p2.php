...
<div class="container my-5">
    <div class="row aproduct-card" id="home_tablerunner_p2">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p2.php" class="product-link">
                 <img src="../../../productimgs/home/tablerunner/p2/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/tablerunner/p2/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p2/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p2/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p2/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p2/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p2/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p2/6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p2/7.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Beige Fused Stripe Luxe Table Runner</h2>
            <p class="mt-3 aproduct-description">Modern, elegant, washable dining decor.<br> 
                ...
                <span><b>Size:</b> 74x14 inches</span>
            </p>
...
<div style="text-align:justify;">
    ...
    <ul>
        <li><b>Premium Quality:</b> Made from 100% pure cotton for softness and durability.</li>
        <li><b>Perfect Dimensions:</b> At 74 x 14 inches, it’s designed for 6-seater dining tables, ideal for family dinners and special occasions.</li>
        <li><b>Stylish Beige Stripes:</b> Modern striped design adds elegance and warmth to your decor, complementing any color scheme.</li>
        <li><b>Enhanced Durability:</b> Fused fabric for extra strength, ensuring it withstands everyday use without losing its charm.</li>
        <li><b>Easy Care:</b> Machine washable for effortless cleaning; retains color and quality after multiple washes.</li>
        <li><b>Versatile Use:</b> Perfect for dining tables, coffee tables, or foyer tables—adds a stylish touch to any space.</li>
        <li><b>Surface Protection:</b> Safeguards your table from spills and scratches while enhancing your home decor.</li>
        <li><b>Elevate Your Decor:</b> A simple yet effective way to refresh your dining experience, perfect for everyday use or festive occasions.</li>
    </ul>
</div>
