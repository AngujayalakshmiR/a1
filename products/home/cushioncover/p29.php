...
<div class="container my-5">
    <div class="row aproduct-card" id="home_cushioncover_p29">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="../../../productimgs/home/cushioncover/p29/main.jpg" class="product-link">
                 <img src="../../../productimgs/home/cushioncover/p29/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/cushioncover/p29/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p29/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p29/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Cotton Love Print Cushion Covers (Set of 2)</h2>
            <p class="mt-3 aproduct-description">Soft, stylish & durable with hidden zipper closure.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 329/ Pack</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹599</del></span></span>  <br>
    ...
    <li><b>Colour:</b> Multicolor</li>
    <li><b>Product Dimensions:</b> 43.2L x 43.2W Centimeters</li>
...
<div style="text-align:justify;">
    ...
    <ul>
        <li><b>Natural Material:</b> Made from 100% natural cotton fibers, ensuring a soft and comfortable feel. Size: 17 x 17 Inches.</li>
        <li><b>Breathability:</b> Keeps cushions cool in warm weather and warm in cooler conditions, perfect for year-round use.</li>
        <li><b>Hypoallergenic:</b> Ideal for individuals with sensitive skin or allergies, offering a gentle and irritation-free surface.</li>
        <li><b>Softness and Comfort:</b> Enhances relaxation with its naturally soft texture, making it a luxurious addition to sofas, armchairs, and beds.</li>
        <li><b>Hidden Zipper Closure:</b> Ensures easy removal and washing while maintaining a sleek and polished appearance.</li>
    </ul>
</div>
