...
<div class="container my-5">
    <div class="row aproduct-card" id="home_cushioncover_p10">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="../../../productimgs/home/cushioncover/p10/main.jpg" class="product-link">
                 <img src="../../../productimgs/home/cushioncover/p10/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/cushioncover/p10/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p10/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p10/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p10/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Cotton Bird Print Cushion Covers (Pack of 2)</h2>
            <p class="mt-3 aproduct-description">Elegant design with hidden zipper, perfect for home decor.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 269/ Pack</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹400</del></span></span>  <br>
    ...
    <li><b>Product Dimensions:</b> 45.7L x 45.7W Centimeters</li>
...
<div style="text-align:justify;">
    ...
    <ul>
        <li><b>Natural Material:</b> Cotton cushion covers are made from 100% natural cotton fibers, providing a soft and comfortable surface for seating or resting. Size: 18inch x 18inch.</li>
        <li><b>Breathability:</b> Cotton is a breathable material, ensuring that cushions stay cool in warmer weather and offer warmth in cooler conditions, making these covers suitable for year-round use.</li>
        <li><b>Hypoallergenic:</b> Ideal for individuals with sensitive skin or allergies, cotton cushion covers are hypoallergenic and gentle, offering a non-irritating surface.</li>
        <li><b>Softness and Comfort:</b> The natural softness of cotton adds a touch of luxury to any seating area, enhancing the comfort and coziness of sofas, armchairs, and beds.</li>
