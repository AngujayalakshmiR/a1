...
<div class="container my-5">
    <div class="row aproduct-card" id="home_cushioncover_p8">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="../../../productimgs/home/cushioncover/p8/main.jpg" class="product-link">
                 <img src="../../../productimgs/home/cushioncover/p8/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/cushioncover/p8/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p8/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p8/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p8/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p8/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/home/cushioncover/p8/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Soft Silk Embroidered Cushion Covers (Pack of 2)</h2>
            <p class="mt-3 aproduct-description">Quilted design with hidden zipper, perfect for home décor.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 249/ Pack</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹499</del></span></span>  <br>
            ...
            <br><br>
            <ul>
    <li><b>Pattern:</b> Embroidery</li>
    <li><b>Material:</b> Silk Cotton</li>
    <li><b>Colour:</b> Brown</li>
    <li><b>Product Dimensions:</b> 38.1L x 38.1W Centimeters</li>
...
<div style="text-align:justify;">
    ...
    <ul>
        <li><b>Elegant Aesthetic:</b> Soft silk cushion covers bring a touch of luxury and sophistication to any space, enhancing the overall decor with their natural sheen and smooth texture. Size: 15inch x 15inch.</li>
        <li><b>Luxurious Feel:</b> Made from high-quality silk, these cushion covers provide a sumptuous and silky surface that feels incredibly soft against the skin, perfect for adding comfort to any seating area.</li>
        <li><b>Hypoallergenic Properties:</b> Silk is a natural, hypoallergenic material, making these cushion covers ideal for people with sensitive skin or allergies, ensuring a comfortable and safe environment.</li>
        <li><b>Hidden Zipper Closure:</b> Equipped with a hidden zipper closure, these covers are easy to remove and wash, maintaining a sleek appearance.</li>
        <li><b>Comfortable Support:</b> The softness of silk adds an extra layer of comfort to cushions, making them ideal for relaxation, whether you’re lounging on the sofa, sitting in a cozy armchair, or reclining in bed.</li>
    </ul>
</div>
