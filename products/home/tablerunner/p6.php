...
<div class="container my-5">
    <div class="row aproduct-card" id="home_tablerunner_p6">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p6.php" class="product-link">
                 <img src="../../../productimgs/home/tablerunner/p6/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/tablerunner/p6/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p6/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p6/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p6/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p6/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p6/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p6/6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p6/7.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Blue Striped Cotton Table Runner</h2>
            <p class="mt-3 aproduct-description">Elegant, durable, and perfect for decor.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 299/ Peice</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹499</del></span></span>  <br>
...
<div style="text-align:justify;">
    ...
    <ul>
        <li><b>100% Pure Cotton Material:</b> Premium-quality cotton for a soft, durable, and eco-friendly table runner.</li>
        <li><b>Perfect for 6-Seater Tables:</b> Sized at 74x14 inches, ideal for dining, coffee, or foyer tables.</li>
        <li><b>Stylish Blue Stripes Design:</b> Adds a modern, elegant touch to any room or occasion.</li>
        <li><b>Fused for Added Durability:</b> Reinforced strength makes it suitable for everyday use and festive gatherings.</li>
        <li><b>Easy-Care & Washable:</b> Machine washable fabric ensures easy maintenance and long-lasting beauty.</li>
        <li><b>Versatile Tabletop Decor:</b> Perfect for use on dining tables, coffee tables, or even as a foyer accent.</li>
        <li><b>Protects & Enhances Surfaces:</b> Stylishly safeguards surfaces from spills, scratches, and wear.</li>
        <li><b>Eco-Friendly Home Decor:</b> Crafted from pure cotton for a sustainable choice in table linens.</li>
    </ul>
</div>
