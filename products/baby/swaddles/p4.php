...
<div class="container my-5">
    <div class="row aproduct-card" id="baby_swaddles_p4">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p4.php" class="product-link">
                 <img src="../../../productimgs/baby/swaddle/p4/main1.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/baby/swaddle/p4/main1.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p4/main.jpg" 
                        alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p4/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p4/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p4/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p4/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p4/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">  Organic Muslin Towel – Rainbow Print </h2>
            <p class="mt-3 aproduct-description">Ultra-soft 120x100 cm towel for babies, toddlers & adults.<br> 
    ...
    <li><b>Pattern:</b> Rainbow Printed</li>
    <li><b>Special Feature:</b> Skin Friendly, Long Lasting, Quick Dry, Super Soft, Breathable</li>
</ul>
...
<div style="text-align:justify;">
    ...
    <li><b>100% Organic Cotton:</b> Gentle and soft fabric, perfect for sensitive baby skin.</li>
    <li><b>Vibrant Rainbow Print:</b> Colorful, cheerful design adds fun to bath time.</li>
    <li><b>Generously Sized:</b> 49x39 inches, ideal for babies, toddlers, and adults.</li>
    <li><b>Versatile Use:</b> Can be used as a bath towel, swaddle wrap, or baby blanket.</li>
    <li><b>Quick-Drying & Absorbent:</b> Keeps your baby cozy and dry after bath time.</li>
    <li><b>Eco-Friendly Choice:</b> Made with sustainable organic cotton for a healthier planet.</li>
    <li><b>Durable & Soft:</b> Maintains softness and strength wash after wash.</li>
    <li><b>Perfect Gift Idea:</b> Ideal for baby showers, new parents, or as a thoughtful gift.</li>
</div>
