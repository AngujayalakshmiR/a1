...
<div class="container my-5">
    <div class="row aproduct-card" id="home_cushioncover_p31">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="../../../productimgs/home/cushioncover/p31/main.jpg" class="product-link">
                 <img src="../../../productimgs/home/cushioncover/p31/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/cushioncover/p31/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p31/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p31/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/home/cushioncover/p31/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p31/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Multicolor Geometric Cotton Cushion Covers (Set of 2)</h2>
            <p class="mt-3 aproduct-description">Hidden zipper, stylish sofa décor.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 199/ Pack</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹799</del></span></span>  <br>
...
<div style="text-align:justify;">
    ...
    <ul>
        <li><b>Natural Material:</b> Made from 100% natural cotton fibers, these cushion covers provide a soft and comfortable surface for seating or resting. Size: 18 x 18 inches.</li>
        <li><b>Breathability:</b> The breathable cotton fabric keeps cushions cool in warm weather and offers warmth in cooler conditions, making them ideal for year-round use.</li>
        <li><b>Hypoallergenic:</b> Perfect for individuals with sensitive skin or allergies, offering a non-irritating and gentle surface.</li>
        <li><b>Softness & Comfort:</b> The natural softness of cotton enhances the comfort and coziness of sofas, armchairs, and beds.</li>
        <li><b>Hidden Zipper Closure:</b> Designed with a hidden zipper for easy removal and washing while maintaining a sleek look.</li>
        <li><b>Wide Applicability:</b> Versatile enough for casual living rooms, formal spaces, outdoor areas, and bedrooms, adding both comfort and style.</li>
    </ul>
</div>
