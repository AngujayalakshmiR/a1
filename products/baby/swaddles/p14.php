...
<div class="container my-5">
    <div class="row aproduct-card" id="baby_swaddles_p14">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p14.php" class="product-link">
                 <img src="../../../productimgs/baby/swaddle/p14/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/baby/swaddle/p14/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                
                <img src="../../../productimgs/baby/swaddle/p14/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p14/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p14/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p14/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p14/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/baby/swaddle/p14/6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Swaddle Set–Strawberry & Shark (Pack of 2)</h2>
            <p class="mt-3 aproduct-description">Ultra-soft 100x100 cm swaddles with cute prints.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 499/ Set </b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹699</del></span></span>  <br>
    ...
    <li><b>Special Feature:</b> Skin Friendly, Lightweight, Fade Resistant, Durable, Breathable</li>
    <li><b>Style:</b> Modern</li>
    <li><b>Blanket Form:</b> Swaddle</li>
    <li><b>Age Range:</b> Baby</li>
    <li><b>Product Dimensions:</b> 103L x 103W Centimeters</li>
    <li><b>Theme:</b> FISH, STRAWBERRY</li>
    <li><b>Pattern:</b> Muslin Swaddle</li>
</ul>

<div style="text-align:justify;">
    <h4>About this item</h4>
    <ul>
        <li><b>Ultra Soft Muslin Cotton Material:</b> Made from premium muslin cotton for a soft and breathable feel.</li>
        ...
        <li><b>100% Muslin Cotton, Ultra-Soft & Breathable:</b> Gentle on your baby’s sensitive skin, providing comfort and breathability.</li>
        <li><b>Multi-Purpose Use:</b> Can be used as a swaddle, blanket, burp cloth, nursing cover, stroller cover, diaper changing mat, washcloth, or baby wipes.</li>
        <li><b>Large & Versatile Size (100 x 100 cm):</b> Ideal for swaddling, wrapping, and daily baby care needs.</li>
        <li><b>Quick Dry & High Absorbency:</b> Absorbs moisture effectively and dries quickly, perfect for spills, drools, and bath time.</li>
    </ul>
</div>
