...
<div class="container my-5">
    <div class="row aproduct-card" id="home_cushioncover_p21">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="../../../productimgs/home/cushioncover/p21/main.jpg" class="product-link">
                 <img src="../../../productimgs/home/cushioncover/p21/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/cushioncover/p21/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p21/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p21/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p21/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/home/cushioncover/p21/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/home/cushioncover/p21/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Cotton Throw Pillow Cushion Covers (Set of 2)</h2>
            <p class="mt-3 aproduct-description">Super soft & stylish, ideal for home décor.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 199/ Pack</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹499</del></span></span>  <br>
            ...
            <br><br>
            <ul>
    <li><b>Pattern:</b> Plain</li>
    <li><b>Material:</b> Cotton</li>
    <li><b>Colour:</b> Peach Pink</li>
    <li><b>Product Dimensions:</b> 40.6L x 40.6W Centimeters</li>
</ul>

<div style="text-align:justify;">
    <h4>About this item</h4>
    <ul>
        <li><b>Material:</b> 100% Pure Cotton</li>
        <li><b>Perfect Size:</b> Each cover measures 16x16 inches</li>
        <li><b>Cushion Cover Colour:</b> Peach Pink</li>
        <li><b>Super Soft Pure Cotton:</b> Indulge in luxurious comfort with our BIGMOON Home Decor Peach Pink Throw Pillow Covers, crafted from premium 100% pure cotton for a soft and cozy feel.</li>
        <li><b>Chic Peach Pink Design:</b> Add a pop of color to your home decor with the elegant peach pink hue, creating a warm and inviting atmosphere in any room.</li>
        <li><b>Convenient Zipper Closure:</b> Each cushion cover features a durable zipper closure for easy insertion and removal of pillows, ensuring a snug and seamless fit.</li>
    </ul>
</div>
