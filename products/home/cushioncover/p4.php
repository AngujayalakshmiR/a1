...
<div class="container my-5">
    <div class="row aproduct-card" id="home_cushioncover_p4">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="../../../productimgs/home/cushioncover/p4/main.jpg" class="product-link">
                 <img src="../../../productimgs/home/cushioncover/p4/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/cushioncover/p4/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p4/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p4/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p4/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p4/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/home/cushioncover/p4/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/home/cushioncover/p4/6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Classic Beige Embroidered Cushion Covers (Pack of 5)</h2>
            <p class="mt-3 aproduct-description">Decorative & festive, ideal for sofa, bed & living spaces.<br> 
...
<div style="text-align:justify;">
    ...
    <ul>
        <li><b>Premium Poly Cotton Fabric:</b> Soft and breathable for comfort and durability.</li>
        <li><b>Elegant Embroidered Design:</b> Intricate beige embroidery adds sophistication.</li>
        <li><b>Perfect for Festive Occasions:</b> Ideal for Christmas, New Year, and Pongal.</li>
        <li><b>Versatile 15 x 15 Inch Size:</b> Fits sofas, chairs, beds, and holiday decor.</li>
        <li><b>Easy Maintenance:</b> Machine washable for hassle-free care.</li>
        <li><b>Perfect Gift for the Season:</b> Stylish gift for housewarmings and holidays.</li>
    </ul>
</div>
