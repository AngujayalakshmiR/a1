...
<div class="container my-5">
    <div class="row aproduct-card" id="baby_swaddles_p16">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p16.php" class="product-link">
                 <img src="../../../productimgs/baby/swaddle/p16/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/baby/swaddle/p16/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                
                <img src="../../../productimgs/baby/swaddle/p16/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p16/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p16/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p16/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p16/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/baby/swaddle/p16/6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/baby/swaddle/p16/7.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <div class="col-md-6 " >
            ...
            <p class="mt-3 aproduct-description">Ultra-soft 110x70 cm towel with cute prints.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 299/ Set </b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹999</del></span></span>  <br>
...
<div style="text-align:justify;">
    ...
    <ul>
        ...
        <li><b>100% Organic Muslin Cotton –</b> Made from super gentle muslin fabric, perfect for newborn skin.</li>
        <li><b>Highly Absorbent & Quick-Drying –</b> Keeps your baby dry and comfortable after bath time.</li>
        <li><b>Multi-Purpose Use –</b> Ideal for bath time, swaddling, burping, or as a lightweight blanket.</li>
        <li><b>Hypoallergenic & Safe –</b> Free from harmful chemicals, making it safe for delicate baby skin.</li>
        <li><b>Machine Washable & Long-Lasting –</b> Softens with every wash and remains durable over time.</li>
        <li><b>Portable & Convenient –</b> Easy to carry, lightweight, and designed for long-lasting use.</li>
    </ul>
</div>
