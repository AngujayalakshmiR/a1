...
<div class="container my-5">
    <div class="row aproduct-card" id="home_cushioncover_p22">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="../../../productimgs/home/cushioncover/p22/main.jpg" class="product-link">
                 <img src="../../../productimgs/home/cushioncover/p22/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/cushioncover/p22/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p22/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p22/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p22/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Fluffy Heart Cushions (Set of 2)</h2>
            <p class="mt-3 aproduct-description">Ultra-soft & cozy, perfect for home & car décor.<br> 
            ...
            <br><br>
            <ul>
    <li><b>Fill Material:</b> Plush</li>
    <li><b>Pillow Type:</b> Furniture Cushion</li>
    <li><b>Colour:</b> Red</li>
    <li><b>Size:</b> Standard</li>
    <li><b>Shape:</b> Heart</li>
    <li><b>Special Feature:</b> Washable</li>
    <li><b>Cover Material:</b> Fur</li>
    <li><b>Age Range:</b> Adult</li>
...
<div style="text-align:justify;">
    ...
    <ul>
        <li><b>Color:</b> Red</li>
        <li><b>Size:</b> 14 x 10 Inches</li>
        <li><b>Quantity:</b> Set of 2</li>
        <li><b>Ultra-Soft Comfort:</b> Crafted with ultra-soft fur for a plush and inviting feel, perfect for cuddling on the sofa or enhancing bedroom comfort.</li>
        <li><b>Valentine's Day Special Edition:</b> Celebrate the season of love with our special red fur heart-shaped pillows, a thoughtful and delightful gift for your special someone.</li>
        <li><b>Coordinated Look:</b> Set of 2 pillows for a coordinated and stylish appearance, use together or place in different areas for a harmonious feel.</li>
    </ul>
</div>
