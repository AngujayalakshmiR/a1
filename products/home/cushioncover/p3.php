...
<div class="container my-5">
    <div class="row aproduct-card" id="home_cushioncover_p3">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="../../../productimgs/home/cushioncover/p3/main.jpg" class="product-link">
                 <img src="../../../productimgs/home/cushioncover/p3/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/cushioncover/p3/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p3/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p3/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p3/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p3/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Christmas Cotton Cushion Covers (Pack of 3)</h2>
            <p class="mt-3 aproduct-description">Soft & festive, ideal for home, sofa & New Year decor.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 349/ Pack</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹899</del></span></span>  <br>
...
<div style="text-align:justify;">
    ...
    <ul>
        <li><b>Premium Cotton Material:</b> Crafted from 100% pure cotton, these covers are soft, breathable, and durable for cozy, festive decor.</li>
        <li><b>Festive Xmas Designs:</b> Features vibrant snowflakes, stars, and Merry Christmas text for a joyful holiday ambiance.</li>
        <li><b>Perfect 20x20 Inch Size:</b> Fits standard throw pillows, perfect for sofas, beds, chairs, and cozy corners.</li>
        <li><b>Set of 3 Covers:</b> Includes 3 Christmas-themed designs for versatile decor styling.</li>
        <li><b>Elegant Off-White Base:</b> Complements vibrant holiday colors, blending with modern or traditional setups.</li>
        <li><b>Versatile Holiday Decor:</b> Ideal for Christmas parties, family gatherings, or New Year celebrations.</li>
    </ul>
</div>
