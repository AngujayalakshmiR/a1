...
<div class="container my-5">
    <div class="row aproduct-card" id="baby_swaddles_p5">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
            ...
            <img src="../../../productimgs/baby/swaddle/p5/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                
                <img src="../../../productimgs/baby/swaddle/p5/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p5/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p5/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p5/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p5/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/baby/swaddle/p5/6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">  Muslin Swaddle – 2 Pack</h2>
            <p class="mt-3 aproduct-description">Soft swaddles with brown floral & rainbow prints.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 499/ Set </b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹1299</del></span></span>  <br>
    ...
    <li><b>Special Feature:</b> Durable, Breathable</li>
    <li><b>Style:</b> Modern</li>
    <li><b>Blanket Form:</b> Swaddle</li>
    <li><b>Age Range (Description):</b> Baby</li>
    <li><b>Product Dimensions:</b> 120L x 100W Centimeters</li>
    <li><b>Pattern:</b> Rainbow, Aesthetic Brown Floral</li>
    <li><b>Seasons:</b> All</li>
</ul>
<div style="text-align:justify;">
    <h4>About this item</h4>
    <li><b>Premium Organic Muslin Fabric:</b> Made with 100% organic muslin, soft and breathable for delicate newborn skin.</li>
    <li><b>Extra-Large Size for Versatility:</b> Generously sized at 120x100 cm, perfect for newborns and toddlers (0-24 months).</li>
    <li><b>Multi-Functional Design:</b> Use as a swaddle, blanket, towel, nursing cover, stroller cover, or burp cloth.</li>
    <li><b>Beautiful Rainbow & Aesthetic Brown Prints:</b> Chic designs for a stylish touch in your baby’s essentials.</li>
    <li><b>Breathable & Lightweight:</b> Prevents overheating, ensuring your baby stays cool, comfy, and secure.</li>
    <li><b>Machine Washable & Durable:</b> Retains softness and print quality even after multiple washes.</li>
    <li><b>Ideal Gift for New Parents:</b> Thoughtful baby shower gift that’s practical and elegant for daily use.</li>
    <li><b>100% Satisfaction Guaranteed:</b> Designed to provide comfort, convenience, and happy parenting moments.</li>
</div>
