...
<div class="container my-5">
    <div class="row aproduct-card" id="home_tablecloth_p1">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p1.php" class="product-link">
                 <img src="../../../productimgs/home/tablecloth/p1/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/tablecloth/p1/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablecloth/p1/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablecloth/p1/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablecloth/p1/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablecloth/p1/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <!-- <img src="../../../productimgs/home/tablecloth/p1/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;"> -->
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Red Christmas Cotton Tablecloth</h2>
            <p class="mt-3 aproduct-description">Festive, washable, 6-seater dining cover.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 699/ Peice</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹1399</del></span></span>  <br>
    ...
    <li><b>Special Feature:</b> Fitted, Lightweight, Heat Resistant</li>
...
<div style="text-align:justify;">
    ...
    <ul>
        ...
        <li><b>Vibrant Christmas Design:</b> Features festive red Christmas prints, creating a joyful and cozy atmosphere for your holiday gatherings.</li>
