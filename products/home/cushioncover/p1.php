...
<div class="container my-5">
    <div class="row aproduct-card" id="home_cushioncover_p1">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="../../../productimgs/home/cushioncover/p1/main1.jpg" class="product-link">
                 <img src="../../../productimgs/home/cushioncover/p1/main1.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/cushioncover/p1/main1.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p1/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p1/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p1/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p1/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p1/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Cotton Floral Cushion Covers (Set of 5)</h2>
            <p class="mt-3 aproduct-description">Soft, durable & festive décor for home & living.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 399/ Pack</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹699</del></span></span>  <br>
...
<div style="text-align:justify;">
    ...
    <ul>
        <li><b>Premium 100% Cotton Fabric:</b> Made from soft, breathable, and durable 100% cotton for a comfortable, cozy feel on your sofa, couch, or bed.</li>
        <li><b>Vibrant Floral Design:</b> Features a beautiful mix of blue and multi-color floral prints that add elegance and charm to your living room or bedroom decor.</li>
        <li><b>Perfect 18x18 Inch Size:</b> Ideal for standard-sized throw pillows, perfect for decorating sofas, couches, chairs, and beds.</li>
        <li><b>Set of 5 Cushion Covers:</b> Includes 5 matching cushion covers to enhance your home decor with a coordinated look and style.</li>
        <li><b>Versatile Home Decor:</b> Perfect for adding a festive touch to your living room, bedroom, or any space. Great for seasonal decorating and year-round elegance.</li>
        <li><b>Durable and Long-lasting:</b> Made with high-quality cotton, these cushion covers retain their softness, vibrant color, and durability after multiple washes.</li>
    </ul>
</div>
