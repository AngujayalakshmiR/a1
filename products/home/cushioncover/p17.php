...
<div class="container my-5">
    <div class="row aproduct-card" id="home_cushioncover_p17">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="../../../productimgs/home/cushioncover/p17/main.jpg" class="product-link">
                 <img src="../../../productimgs/home/cushioncover/p17/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/cushioncover/p17/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p17/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p17/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p17/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/home/cushioncover/p17/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p17/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p17/6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Embroidered Poly Cotton Cushion Covers (Set of 5)</h2>
            <p class="mt-3 aproduct-description">Classic pink festive throw pillows for home & living.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 319/ Pack</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹799</del></span></span>  <br>
    ...
    <li><b>Material:</b> Polycotton</li>
    <li><b>Colour:</b> Pink</li>
    <li><b>Product Dimensions:</b> 38L x 38W Centimeters</li>
...
<div style="text-align:justify;">
    ...
    <ul>
        ...
        <li><b>Premium Poly-Cotton Fabric:</b> Soft, durable, and long-lasting for year-round comfort.</li>
        <li><b>Elegant Pink Embroidery:</b> Festive charm for Christmas, New Year, and Pongal.</li>
        <li><b>Perfect Size:</b> 15x15 inches, fits most standard pillows, ideal for sofas and beds.</li>
        <li><b>Versatile Use:</b> Perfect for sofas, beds, chairs, and more to enhance home decor.</li>
        <li><b>Easy Care:</b> Machine washable for effortless cleaning and long-lasting colors.</li>
        <li><b>Festive Appeal:</b> Ideal for adding festive decor to your Christmas, New Year, and Pongal celebrations.</li>
    </ul>
</div>
