...
<div class="container my-5">
    <div class="row aproduct-card" id="home_cushioncover_p20">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="../../../productimgs/home/cushioncover/p20/main.jpg" class="product-link">
                 <img src="../../../productimgs/home/cushioncover/p20/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/cushioncover/p20/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p20/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p20/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p20/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/home/cushioncover/p20/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/home/cushioncover/p20/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p20/6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/home/cushioncover/p20/7.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Cotton Waffle Textured Cushion Covers (Set of 2)</h2>
            <p class="mt-3 aproduct-description">Soft & durable, ideal for home & office décor.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 599/ Pack</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹599</del></span></span>  <br>
...
<div style="text-align:justify;">
    ...
    <ul>
        <li><b>Luxurious Cotton Fabric:</b> Made from 100% premium cotton with a breathable waffle texture for a cozy and elegant feel.</li>
        <li><b>Perfect Size & Fit:</b> 18x18 inches (45x45 cm), ideal for sofas, couches, beds, chairs, and accent furniture.</li>
        <li><b>Stylish Waffle Design:</b> Adds a modern, aesthetic touch to home decor, perfect for festive and everyday styling.</li>
        <li><b>Festive Vibes & Cozy Ambiance:</b> A rich yellow color complements seasonal themes like Valentine's, Diwali, Christmas, and housewarming decor.</li>
        <li><b>Hidden Zipper Closure:</b> Smooth, concealed zipper ensures easy cushion insertion and a seamless, elegant finish.</li>
        <li><b>Soft, Durable & Fade-Resistant:</b> Long-lasting, breathable fabric retains its vibrant color and texture after multiple washes.</li>
    </ul>
</div>
