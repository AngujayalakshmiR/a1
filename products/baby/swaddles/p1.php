...
<div class="container my-5">
    <div class="row aproduct-card" id="baby_swaddles_p1">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p1.php" class="product-link">
                 <img src="../../../productimgs/baby/swaddle/p1/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/baby/swaddle/p1/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p1/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p1/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p1/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p1/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p1/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p1/6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <div class="col-md-6 " >
            ...
            <ul>
                ...
                <li><b>Theme:</b> Floral</li>
                <li><b>Pattern:</b> Sunflower, Aesthetic Brown Floral</li>
            </ul>
            ...
            <div style="text-align:justify;">
                ...
                <li><b>100% Organic Muslin Fabric:</b> Crafted from premium muslin, these swaddles are soft, breathable, and gentle on delicate newborn skin.</li>
                <li><b>Generous Size for Versatility:</b> Large 120x100 cm design ensures perfect wrapping for newborns and toddlers (0-24 months).</li>
                <li><b>Multi-Use Functionality:</b> Use as a swaddle, towel, blanket, nursing cover, burp cloth, or stroller cover. Ideal for all parenting moments.</li>
                <li><b>Stylish Sunflower & Aesthetic Brown Prints:</b> Elegant designs to complement your baby’s nursery or outings with style.</li>
                <li><b>Breathable and Skin-Friendly:</b> Keeps your baby cool and comfortable while reducing the risk of overheating.</li>
                <li><b>Durable & Machine Washable:</b> Easy to maintain, these swaddles stay soft and intact after multiple washes.</li>
            </div>
