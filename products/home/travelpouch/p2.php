...
<div class="container my-5">
    <div class="row aproduct-card" id="home_travelpouch_p2">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p2.php" class="product-link">
                 <img src="../../../productimgs\home\travelpouch\p2\main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs\home\travelpouch\p2\main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                
                <img src="../../../productimgs\home\travelpouch\p2\1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs\home\travelpouch\p2\2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs\home\travelpouch\p2\3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs\home\travelpouch\p2\4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <!-- <img src="../../../productimgs\home\travelpouch\p2\5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs\home\travelpouch\p2\6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs\home\travelpouch\p2\7.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;"> -->
        ...
        <div class="col-md-6 " >
            ...
            <p class="mt-3 aproduct-description">Convenient organizer for sanitary napkins, chargers, cables, earphones & cosmetics.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 199/ Piece </b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹399</del></span></span>  <br>
...
<div style="text-align:justify;">
    ...
    <li><b>Quilted Elegance:</b> The pouches boast a quilted design, adding a touch of sophistication to your organizational style.</li>
    <li><b>Secure Zip Closure:</b> Each pouch features a reliable zip closure, ensuring the safety of your essentials while on the move.</li>
    <li><b>Versatile Organization:</b> Perfect for office essentials, sanitary napkins, chargers, cables, earphones, and cosmetics, providing versatile storage for various needs.</li>
    <li><b>Travel-Friendly:</b> Designed for travelers, these pouches are compact, lightweight, and easily fit into your bag, making them perfect for on-the-go lifestyles.</li>
</div>
