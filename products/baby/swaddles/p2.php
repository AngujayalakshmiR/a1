...
<div class="container my-5">
    <div class="row aproduct-card" id="baby_swaddles_p2">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p2.php" class="product-link">
                 <img src="../../../productimgs/baby/swaddle/p2/main1.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/baby/swaddle/p2/main1.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p2/main.jpg" 
                        alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p2/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p2/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p2/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p2/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p2/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
...
<div style="text-align:justify;">
    ...
    <li><b>Premium Organic Cotton:</b> Ultra-soft, breathable, and gentle on your baby’s skin.</li>
    <li><b>Versatile Size:</b> 120x100 cm (49 x 39 inches) – perfect for babies, toddlers, and adults.</li>
    <li><b>Stylish Design:</b> Aesthetic brown floral pattern adds charm to bath time.</li>
    <li><b>Quick-Drying & Absorbent:</b> Absorbs moisture efficiently, keeping skin dry and comfy.</li>
    <li><b>Multi-Use:</b> Ideal as a bath towel, swaddle, beach towel, or toddler towel.</li>
    <li><b>Eco-Friendly:</b> 100% organic cotton, sustainable, and gentle on the environment.</li>
    <li><b>Machine Washable:</b> Retains softness and design after multiple washes.</li>
    <li><b>Perfect Gift:</b> A thoughtful gift for baby showers or new parents.</li>
</div>
