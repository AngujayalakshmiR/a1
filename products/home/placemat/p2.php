...
<div class="container my-5">
    <div class="row aproduct-card" id="home_placemat_p2">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p2.php" class="product-link">
                 <img src="../../../productimgs\home\placemat\p2\main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs\home\placemat\p2\main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                
                <img src="../../../productimgs\home\placemat\p2\1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs\home\placemat\p2\2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs\home\placemat\p2\3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs\home\placemat\p2\4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <!-- <img src="../../../productimgs\home\blankets\p1\5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;"> -->
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Dark Blue Cotton Placemats</h2>
            <p class="mt-3 aproduct-description">Soft, durable, machine-washable dining set(Set of 4).<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 249/ Piece </b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹299</del></span></span>  <br>
                <span><b>Weight:</b> 1200g/peice</span><br>
                <span><b>Size:</b> 19x13 inches</span>
            </p>
            ...
            <ul>
    <li><b>Colour:</b> Dark Blue</li>
    <li><b>Material:</b> Cotton</li>
    <li><b>Size:</b> 19 x 13 inch</li>
    <li><b>Occasion:</b> Birthday, Valentine's Day</li>
</ul>
...
<div style="text-align:justify;">
    ...
    <li><b>Colour:</b> Dark Blue</li>
    <li><b>Material:</b> Made from 100% pure cotton for a soft and durable surface, enhancing the dining experience.</li>
    <li><b>Size:</b> Generous size of 19x13 inches (48x33 cm)</li>
    <li><b>Versatile:</b> Perfect for everyday use or special occasions, providing an elegant backdrop for your tableware.</li>
    <li><b>Set of 4:</b> High-quality placemats in vibrant dark blue, adding a pop of color to your dining space.</li>
    <li><b>Elevate Your Dining Decor:</b> Bigmoon's premium pure cotton placemats – a perfect blend of style and functionality.</li>
    <li><b>Easy to Care For:</b> Machine washable design ensures convenient cleanup and long-term use.</li>
</div>
