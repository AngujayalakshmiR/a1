...
<div class="container my-5">
    <div class="row aproduct-card" id="home_cushioncover_p27">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="../../../productimgs/home/cushioncover/p27/main.jpg" class="product-link">
                 <img src="../../../productimgs/home/cushioncover/p27/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/cushioncover/p27/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p27/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p27/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p27/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/home/cushioncover/p27/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p27/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Yellow Waffle Cotton Cushion Covers (Set of 2)</h2>
            <p class="mt-3 aproduct-description">Soft, durable & stylish with zip closure.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 349/ Pack</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹599</del></span></span>  <br>
...
<div style="text-align:justify;">
    ...
    <ul>
        <li><b>Premium 100% Waffle Cotton:</b> Crafted from soft, breathable cotton with a unique waffle texture, adding luxury and comfort to your decor.</li>
        <li><b>Festive and Stylish Decor:</b> Vibrant yellow hue adds a festive feel, perfect for celebrations and seasonal home makeovers.</li>
        <li><b>Ideal for 18x18 Inch Cushions:</b> Designed for standard-sized cushions, this set of two easily enhances sofas, beds, and living room seating.</li>
        <li><b>Durable and Long-Lasting:</b> High-quality stitching and material ensure these covers retain shape, color, and texture over time.</li>
        <li><b>Soft Yet Strong:</b> Balances softness with durability for a cushion cover that feels cozy yet stands up to regular use.</li>
    </ul>
</div>
