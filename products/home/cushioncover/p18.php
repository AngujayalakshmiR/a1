...
<div class="container my-5">
    <div class="row aproduct-card" id="home_cushioncover_p18">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="../../../productimgs/home/cushioncover/p18/main.jpg" class="product-link">
                 <img src="../../../productimgs/home/cushioncover/p18/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/cushioncover/p18/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p18/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p18/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p18/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/home/cushioncover/p18/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p18/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p18/6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <div class="col-md-6 " >
            ...
            <p class="mt-3 aproduct-description">Classic brown festive throw pillows for home & living.<br> 
    ...
    <li><b>Product Dimensions:</b> 40L x 40W Centimeters</li>
...
<div style="text-align:justify;">
    ...
    <ul>
        <li><b>Premium Poly Cotton Fabric:</b> Soft, durable, and long-lasting for everyday and festive use.</li>
        <li><b>Elegant Embroidered Design:</b> Warm brown embroidery adds sophistication to any space.</li>
        <li><b>Versatile Size:</b> Perfect for 16 x 16-inch cushions, enhancing sofas, chairs, and beds.</li>
        <li><b>Festive & Everyday Charm:</b> Ideal for Christmas, Pongal, and year-round decor.</li>
        <li><b>Hidden Zipper Closure:</b> Seamless and easy-to-use with a polished look.</li>
        <li><b>Machine Washable:</b> Simple maintenance to keep vibrant and fresh.</li>
    </ul>
</div>
