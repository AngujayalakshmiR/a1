...
<div class="container my-5">
    <div class="row aproduct-card" id="home_apron_p1">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p1.php" class="product-link">
                 <img src="../../../productimgs\home\apron\p1\main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs\home\apron\p1\main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                
                <img src="../../../productimgs\home\apron\p1\1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs\home\apron\p1\2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs\home\apron\p1\3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs\home\apron\p1\4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs\home\apron\p1\5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Durable unisex waterproof kitchen apron</h2>
            <p class="mt-3 aproduct-description">Waterproof polycotton unisex apron with pocket.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 199/ Piece </b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹299</del></span></span>  <br>
                <span><b>Weight:</b> 200g/peice</span><br>
                <span><b>Size:</b> Free Size</span>
            </p>
            ...
            <ul>
    <li><b>Style:</b> Pinafore</li>
    <li><b>Material:</b> Polycotton</li>
    <li><b>Closure type:</b> Pull On</li>
    <li><b>Number of pockets:</b> 1</li>
    <li><b>Country of Origin:</b> India</li>
</ul>

<div style="text-align:justify;">
    <h4>About this item</h4>
    <li><b>Pockets:</b> 1 pocket for holding mobile phone.</li>
    <li><b>Material:</b> Polycotton.</li>
    <li><b>Waterproof/Oil Proof:</b> Ideal for protection against water and oils.</li>
    <li><b>Machine Washable:</b> Convenient for easy care and cleaning.</li>
    <li><b>Size:</b> Free Size.</li>
    <li><b>Preferable:</b> Unisex.</li>
</div>
