...
<div class="container my-5">
    <div class="row aproduct-card" id="home_tablerunner_p4">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p4.php" class="product-link">
                 <img src="../../../productimgs/home/tablerunner/p4/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/tablerunner/p4/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p4/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p4/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p4/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p4/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <!-- <img src="../../../productimgs/home/tablerunner/p3/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;"> -->
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Beige Luxe Knitted Table Runner</h2>
            <p class="mt-3 aproduct-description">Soft, thick, elegant with golden accents.<br> 
                ...
                <span><b>Size:</b> 90x15 inches</span>
            </p>
    ...
    <li><b>Size:</b> 90 x 15 inch</li>
    <li><b>Product Dimensions:</b> 2.28L x 0.38W Meters</li>
</ul>
<div style="text-align:justify;">
    <h4>About this item</h4>
    <ul>
        <li><b>Premium Quality:</b> Knitted with precision, this table runner boasts a premium beige color with a touch of elegance from lurex golden thread.</li>
        <li><b>Versatile Size:</b> Measuring 90 x 15 inches, it's perfectly sized for 6-8 seater tables, making it an excellent choice for various occasions.</li>
        <li><b>Soft and Thick:</b> Experience the luxurious feel of a soft and thick table runner that not only looks good but also adds a layer of protection to your table.</li>
        <li><b>Washable and Heat Resistant:</b> Practicality meets style with its washable design, ensuring easy care. The heat-resistant feature allows you to serve hot dishes without compromising its quality.</li>
        <li><b>Ideal for Every Occasion:</b> Whether it's a family dinner, an office or kitchen table, indoor/outdoor parties, or daily use, this table runner enhances any setting.</li>
        <li><b>Chic Fringe Detail:</b> The fringe detail adds a touch of charm, making this table runner a stylish addition to your table decor.</li>
    </ul>
</div>
