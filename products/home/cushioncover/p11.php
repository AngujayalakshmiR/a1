...
<div class="container my-5">
    <div class="row aproduct-card" id="home_cushioncover_p11">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="../../../productimgs/home/cushioncover/p11/main.jpg" class="product-link">
                 <img src="../../../productimgs/home/cushioncover/p11/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/cushioncover/p11/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p11/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p11/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p11/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/home/cushioncover/p11/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p11/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p11/6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Cotton Waffle Textured Cushion Covers (Pack of 5)</h2>
            <p class="mt-3 aproduct-description">Soft & durable, ideal for sofa, couch & bedroom.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 1499/ Pack</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹2499</del></span></span>  <br>
            ...
            <br><br>
            <ul>
    <li><b>Pattern:</b> Waffle</li>
    <li><b>Material:</b> Cotton</li>
    <li><b>Colour:</b> Yellow</li>
    <li><b>Product Dimensions:</b> 18L x 18W Centimeters</li>
    <li><b>Style:</b> Classic</li>
</ul>
