...
<div class="container my-5">
    <div class="row aproduct-card" id="baby_swaddles_p12">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p12.php" class="product-link">
                 <img src="../../../productimgs/baby/swaddle/p12/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/baby/swaddle/p12/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                
                <img src="../../../productimgs/baby/swaddle/p12/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p12/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p12/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p12/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p12/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/baby/swaddle/p12/6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/baby/swaddle/p12/7.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/baby/swaddle/p12/8.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Animal Print Muslin Swaddle (Pack of 6)</h2>
            <p class="mt-3 aproduct-description">Soft 70x70 cm swaddles with animal prints for babies.<br> 
    ...
    <li><b>Special Features:</b> Skin Friendly, Lightweight, Hypoallergenic, Durable, Breathable</li>
    <li><b>Style:</b> Modern</li>
    <li><b>Blanket Form:</b> Swaddle</li>
    <li><b>Age Range:</b> Baby (0-18+ months)</li>
    <li><b>Product Dimensions:</b> 70L x 70W Centimeters</li>
    <li><b>Theme:</b> Animals, Love, Insect, Floral, Fruits</li>
    <li><b>Pattern:</b> Penguin, Butterfly, Deer, Elephant, Strawberry, Blue Shark</li>
</ul>
