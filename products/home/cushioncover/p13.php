...
<div class="container my-5">
    <div class="row aproduct-card" id="home_cushioncover_p13">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="../../../productimgs/home/cushioncover/p13/main.jpg" class="product-link">
                 <img src="../../../productimgs/home/cushioncover/p13/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/cushioncover/p13/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p13/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p13/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p13/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/home/cushioncover/p13/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p13/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p13/6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/home/cushioncover/p13/7.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Festive Xmas Cotton Cushion Covers (Pack of 2)</h2>
            <p class="mt-3 aproduct-description">Christmas-themed decorative pillow covers with pom-pom lace.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 299/ Pack</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹799</del></span></span>  <br>
...
<div style="text-align:justify;">
    ...
    <ul>
        <li><b>100% Premium Cotton:</b> Soft, breathable, and durable for long-lasting festive charm.</li>
        <li><b>Vibrant Xmas Prints:</b> Cheerful Christmas tree, snowman, and star designs with multicolour pom-poms.</li>
        <li><b>Ideal 18x18 Size:</b> Perfect for standard throw pillows on sofas, beds, and chairs.</li>
        <li><b>Festive Ambiance:</b> Enhances Christmas and New Year decor with cozy holiday vibes.</li>
        <li><b>Elegant Pom-Poms:</b> Green and red pom-pom borders add a festive touch.</li>
        <li><b>Versatile Decor:</b> Ideal for living rooms, bedrooms, and holiday party setups.</li>
    </ul>
</div>
