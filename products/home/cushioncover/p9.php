...
<div class="container my-5">
    <div class="row aproduct-card" id="home_cushioncover_p9">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="../../../productimgs/home/cushioncover/p9/main.jpg" class="product-link">
                 <img src="../../../productimgs/home/cushioncover/p9/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/cushioncover/p9/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p9/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p9/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p9/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p9/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/home/cushioncover/p9/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Cotton Check Cushion Covers (Pack of 4)</h2>
            <p class="mt-3 aproduct-description">Festive red & white design with pom-pom lace, hidden zipper.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 449/ Pack</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹999</del></span></span>  <br>
...
<div style="text-align:justify;">
    ...
    <ul>
        ...
        <li><b>100% Cotton Fabric:</b> Soft, breathable, and durable for long-lasting comfort.</li>
        <li><b>Festive Red & White Check Design:</b> Perfect for Christmas and New Year celebrations.</li>
        <li><b>Pom-Pom Lace Detail:</b> Adds a playful, charming touch to your home décor.</li>
        <li><b>Set of 4 Covers (18x18 Inches):</b> Ideal for sofas, chairs, beds, or couches.</li>
        <li><b>Hidden Zipper Closure:</b> Sleek and easy to use for cushion insertion/removal.</li>
        <li><b>Machine Washable:</b> Convenient for easy cleaning and maintenance.</li>
    </ul>
</div>
