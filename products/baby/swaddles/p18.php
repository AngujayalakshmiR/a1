...
<div class="container my-5">
    <div class="row aproduct-card" id="baby_swaddles_p18">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p18.php" class="product-link">
                 <img src="../../../productimgs/baby/swaddle/p18/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/baby/swaddle/p18/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                
                <img src="../../../productimgs/baby/swaddle/p18/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p18/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p18/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p18/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p18/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/baby/swaddle/p18/6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/baby/swaddle/p18/7.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Towel Set–Deer & Elephant (Pack of 2)</h2>
            <p class="mt-3 aproduct-description">Cozy 75x140 cm towel with Deer & Elephant prints.<br> 
    ...
    <li><b>Pattern:</b> Deer, Elephant</li>
...
<div style="text-align:justify;">
    ...
    <ul>
        ...
        <li><b>Ultra-Soft & Organic –</b> Made from 100% pure muslin cotton, gentle and breathable for baby’s sensitive skin.</li>
        <li><b>Super Absorbent & Quick-Dry –</b> Instantly absorbs water and dries faster than regular towels, keeping your baby warm and cozy.</li>
        <li><b>Hypoallergenic & Chemical-Free –</b> Designed for newborns and toddlers, free from harsh dyes and synthetic fibers.</li>
        <li><b>Adorable Deer & Elephant Prints –</b> Cute unisex designs make bath time fun and enjoyable!</li>
        <li><b>Multipurpose Baby Essential –</b> Can be used as a bath towel, burp cloth, swaddle, nursing cover, stroller cover, and more!</li>
    </ul>
</div>
