...
<div class="container my-5">
    <div class="row aproduct-card" id="baby_swaddles_p3">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p3.php" class="product-link">
                 <img src="../../../productimgs/baby/swaddle/p3/main1.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/baby/swaddle/p3/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p3/main1.jpg" 
                        alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p3/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p3/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p3/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p3/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p3/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Organic Muslin Swaddle</h2>
            <p class="mt-3 aproduct-description">Ultra-soft sunflower print towel for all ages.<br> 
    ...
    <li><b>Age Range (Description):</b> baby, teen, Baby</li>
    <li><b>Material:</b> Muslin</li>
    <li><b>Product Dimensions:</b> 120L x 100W Centimeters</li>
    <li><b>Number of Items:</b> 1</li>
    <li><b>Style:</b> Modern</li>
    <li><b>Pattern:</b> Aesthetic Brown With Floral</li>
    <li><b>Special Feature:</b> Skin Friendly, Long Lasting, Quick Dry, Super Soft</li>
</ul>
...
<div style="text-align:justify;">
    ...
    <li><b>100% Organic Cotton:</b> Soft, breathable, and gentle on your baby’s delicate skin.</li>
    <li><b>Generous Size (120x100 cm):</b> Ideal for newborns, toddlers, and even adults, offering full coverage.</li>
    <li><b>Sunflower Print Design:</b> Cheerful and aesthetic, perfect for adding charm to bath time.</li>
    <li><b>Quick-Drying & Absorbent:</b> Muslin fabric dries fast and absorbs moisture efficiently.</li>
    <li><b>Multi-Purpose:</b> Use as a bath towel, swaddle wrap, or beach towel for versatile comfort.</li>
    <li><b>Eco-Friendly:</b> Made from 100% organic cotton, providing an earth-conscious choice.</li>
    <li><b>Easy to Maintain:</b> Machine washable, stays soft and vibrant after every wash.</li>
    <li><b>Perfect Gift:</b> Ideal for baby showers, new parents, or newborn care kits.</li>
</div>
