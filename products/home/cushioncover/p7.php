...
<div class="container my-5">
    <div class="row aproduct-card" id="home_cushioncover_p7">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="../../../productimgs/home/cushioncover/p7/main.jpg" class="product-link">
                 <img src="../../../productimgs/home/cushioncover/p7/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/cushioncover/p7/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p7/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p7/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p7/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p7/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Classic Check Cotton Cushion Covers (Pack of 2)</h2>
            <p class="mt-3 aproduct-description">Festive & cozy with pom-pom lace, perfect for home decor.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 299/ Pack</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹599</del></span></span>  <br>
...
<div style="text-align:justify;">
    ...
    <ul>
        <li><b>Premium Cotton Fabric:</b> Made from 100% durable, breathable cotton for a soft, natural feel.</li>
        <li><b>Festive Red & White Checks:</b> Classic design perfect for Christmas, New Year, and cozy home decor.</li>
        <li><b>Elegant Pom-Pom Lace:</b> Adds a charming and decorative touch to your cushions.</li>
        <li><b>Perfect Fit:</b> Sized 18x18 inches, ideal for sofas, beds, and chairs.</li>
        <li><b>Easy to Clean:</b> Machine washable fabric ensures effortless maintenance and long-lasting use.</li>
        <li><b>Hidden Zipper Design:</b> Smooth zipper for easy pillow insertion and a polished look.</li>
    </ul>
</div>
