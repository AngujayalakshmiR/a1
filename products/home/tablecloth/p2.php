...
<div class="container my-5">
    <div class="row aproduct-card" id="home_tablecloth_p2">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p2.php" class="product-link">
                 <img src="../../../productimgs/home/tablecloth/p2/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/tablecloth/p2/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablecloth/p2/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablecloth/p2/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablecloth/p2/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablecloth/p2/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablecloth/p2/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Red Checkered Cotton Tablecloth</h2>
            <p class="mt-3 aproduct-description">Lightweight, stylish, 6-seater table cover.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 499/ Peice</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹899</del></span></span>  <br>
    ...
    <li><b>Product Dimensions:</b> 2.28L x 1.52W Meters</li>
    <li><b>Shape:</b> Rectangular</li>
    <li><b>Recommended Uses For Product:</b> Dining Table</li>
    <li><b>Pattern:</b> Checkered</li>
    <li><b>Style:</b> Modern</li>
    <li><b>Special Feature:</b> Lightweight, Wrinkle Resistant</li>
    <li><b>Seasons:</b> All-Season</li>
</ul>
...
<div style="text-align:justify;">
    ...
    <ul>
        ...
        <li><b>Perfect Size:</b> Measures 60 inches x 90 inches, ideal for most 6-seater rectangular dining tables.</li>
        <li><b>Soft Texture:</b> Crafted from high-quality cotton, providing a comfortable, soft surface for an enhanced dining experience.</li>
        <li><b>Breathability:</b> The natural breathability of cotton makes it suitable for year-round use, keeping the surface cool in warmer climates.</li>
        <li><b>Highly Absorbent:</b> Effectively contains spills and prevents them from seeping through to the table underneath.</li>
        <li><b>Temperature Regulation:</b> Cotton’s natural properties help regulate temperature, ensuring comfort in both summer and winter.</li>
        <li><b>Table Protection:</b> Provides a protective layer against spills, scratches, and heat damage, extending the life of your furniture.</li>
        <li><b>Easy Maintenance:</b> Machine washable for hassle-free cleaning and long-term use.</li>
        <li><b>Versatile Use:</b> Perfect for everyday meals, special occasions, holiday gatherings, and formal dinners, adding sophistication to your dining space.</li>
    </ul>
</div>
