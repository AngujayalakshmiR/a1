...
<div class="container my-5">
    <div class="row aproduct-card" id="home_tablecloth_p3">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p3.php" class="product-link">
                 <img src="../../../productimgs/home/tablecloth/p3/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/tablecloth/p3/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablecloth/p3/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablecloth/p3/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablecloth/p3/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablecloth/p3/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablecloth/p3/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Christmas Floral Cotton Tablecloth</h2>
            <p class="mt-3 aproduct-description">Festive, washable, 6-seater dining cover.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 699/ Peice</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹1299</del></span></span>  <br>
            ...
            <br><br>
            <ul>
    <li><b>Colour:</b> Red and Green</li>
    ...
    <li><b>Occasion:</b> Christmas, New Year</li>
    <li><b>Special Feature:</b> Lightweight</li>
...
<div style="text-align:justify;">
    ...
    <ul>
        <li><b>Premium Cotton Fabric:</b> Crafted from 100% pure cotton, offering softness, durability, and a high-quality feel for your dining table.</li>
        <li><b>Vibrant Christmas Design:</b> Features festive red Christmas floral patterns, creating a joyful and cozy atmosphere for your holiday gatherings.</li>
        <li><b>Perfect for 6-Seater Tables:</b> Ideal size of 60x90 inches, fits most 6-seater rectangular dining tables for an elegant holiday setup.</li>
        <li><b>Washable & Easy to Maintain:</b> Machine washable, ensuring easy care and maintaining vibrant colors throughout the season.</li>
        <li><b>Water-Resistant:</b> Designed to protect your table from spills, stains, and wear while adding a festive touch.</li>
        <li><b>Versatile Holiday Decor:</b> Great for Christmas and New Year’s celebrations, enhancing the look of dining rooms, restaurants, and hotels.</li>
        <li><b>Multi-Use Functionality:</b> Perfect for holiday dinners, family gatherings, and festive parties, bringing warmth to any occasion.</li>
        <li><b>Thoughtful Gift Idea:</b> A wonderful Christmas gift for family and friends, adding charm to their holiday table settings.</li>
    </ul>
</div>
