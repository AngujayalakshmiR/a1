...
<div class="container my-5">
    <div class="row aproduct-card" id="baby_swaddles_p8">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p8.php" class="product-link">
                 <img src="../../../productimgs/baby/swaddle/p8/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/baby/swaddle/p8/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                
                <img src="../../../productimgs/baby/swaddle/p8/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p8/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p8/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p8/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p8/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Muslin Baby Swaddle – 2 Pack</h2>
            <p class="mt-3 aproduct-description">Soft swaddles with rainbow & parachute prints.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 499/ Set </b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹899</del></span></span>  <br>
    ...
    <li><b>Special Feature:</b> Skin Friendly, Lightweight, Super Soft</li>
...
<div style="text-align:justify;">
    ...
    <li><b>Perfect for Swaddling Newborns to 18 months:</b> Provides comfort and full coverage during naps and diaper changes.</li>
    <li><b>Multi-Purpose Use:</b> Ideal for swaddling, blanket, nursing cover, burp cloth, wash cloth, or wipes.</li>
    <li><b>Size:</b> 100x100 cm, suitable for babies from newborn to 18 months.</li>
    <li><b>Ultra-Soft & Breathable Muslin Cloth:</b> Made from lightweight and breathable fabric to keep your baby cozy and cool.</li>
    <li><b>Quick Dry & High Absorbency:</b> 100% cotton fabric ensures quick drying and high absorbency for optimal use after bath time or feedings.</li>
    <li><b>Prints:</b> Rainbow and Parachute prints, adding a cheerful and stylish touch to your baby’s essentials.</li>
</div>
