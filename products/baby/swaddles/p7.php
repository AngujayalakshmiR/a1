...
<div class="container my-5">
    <div class="row aproduct-card" id="baby_swaddles_p7">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p7.php" class="product-link">
                 <img src="../../../productimgs/baby/swaddle/p7/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/baby/swaddle/p7/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                
                <img src="../../../productimgs/baby/swaddle/p7/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p7/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p7/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p7/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p7/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <!-- <img src="../../../productimgs/baby/swaddle/p6/6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/baby/swaddle/p6/7.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;"> -->
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Cotton Muslin Swaddle – 6 Pack</h2>
            <p class="mt-3 aproduct-description">Ultra-soft solid blue swaddles for babies<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 399/ Set </b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹1599</del></span></span>  <br>
                <span><b>Weight:</b> 1000g/set</span><br>
                <span><b>Size:</b>0 to 18 months</span>
            </p>
    ...
    <li><b>Special Feature:</b> Skin Friendly, Breathable</li>
    <li><b>Style:</b> Modern</li>
    <li><b>Blanket Form:</b> Swaddle</li>
    <li><b>Age Range (Description):</b> Baby</li>
    <li><b>Product Dimensions:</b> 70L x 70W Centimeters</li>
...
<div style="text-align:justify;">
    ...
    <li><b>Premium Cotton Muslin:</b> Crafted from 100% pure cotton, these baby swaddle towels are ultra-soft, breathable, and gentle on your baby’s sensitive skin for maximum comfort.</li>
    <li><b>Perfect Size for Newborns:</b> Each towel measures 70x70 cm (27" x 27"), ideal for babies 0-18+ months, providing full coverage and comfort during naps or diaper changes.</li>
    <li><b>Ultra-Soft & Breathable:</b> The lightweight muslin fabric ensures breathability, keeping your little one cozy and cool without overheating.</li>
    <li><b>Versatile Swaddle Wrap:</b> Can be used as a swaddle, burp cloth, towel, or stroller cover, offering multifunctional use for busy parents.</li>
    <li><b>Durable & Long-Lasting:</b> Machine washable and built to withstand repeated use, maintaining its softness and quality wash after wash.</li>
    <li><b>Gentle on Baby Skin:</b> Designed to soothe and comfort your baby, these soft wraps are perfect for sensitive skin, preventing rashes or irritation.</li>
    <li><b>Great Gift for New Parents:</b> This swaddle pack makes an excellent gift for baby showers, newborns, or for any parent looking to provide the best care for their baby.</li>
    <li><b>Safe & Natural:</b> Made from chemical-free cotton, ensuring your baby’s skin is only in contact with natural and safe materials.</li>
</div>
