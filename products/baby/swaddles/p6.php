...
<div class="container my-5">
    <div class="row aproduct-card" id="baby_swaddles_p6">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p6.php" class="product-link">
                 <img src="../../../productimgs/baby/swaddle/p6/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/baby/swaddle/p6/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                
                <img src="../../../productimgs/baby/swaddle/p6/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p6/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p6/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p6/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p6/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
    ...
    <li><b>Pattern:</b> Sunflower, Rainbow, Aesthetic Brown Floral</li>
    <li><b>Seasons:</b> All</li>
</ul>

<div style="text-align:justify;">
    <h4>About this item</h4>
    <li><b>100% Muslin Cotton:</b> Soft, breathable, and gentle for newborns.</li>
    <li><b>Multi-Use:</b> Swaddle, towel, blanket, playmat, or burp cloth.</li>
    <li><b>Generous Size:</b> 120 x 100 cm, ideal for 0-24 months.</li>
    <li><b>Adorable Prints:</b> Sunflower, Rainbow, and Aesthetic Brown.</li>
    <li><b>Perfect Baby Gift:</b> Thoughtful choice for baby showers.</li>
    <li><b>Durable Quality:</b> Fade-resistant and long-lasting.</li>
    <li><b>Easy Care:</b> Machine washable for hassle-free cleaning.</li>
    <li><b>Mom-Approved:</b> Loved by moms for quality and comfort.</li>
</div>
