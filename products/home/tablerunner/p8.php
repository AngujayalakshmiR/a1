...
<div class="container my-5">
    <div class="row aproduct-card" id="home_tablerunner_p8">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p8.php" class="product-link">
                 <img src="../../../productimgs/home/tablerunner/p8/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/tablerunner/p8/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p8/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p8/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p8/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p8/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p8/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p8/6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <!-- <img src="../../../productimgs/home/tablerunner/p7/7.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;"> -->
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Misty Blue Cotton Table Runner</h2>
            <p class="mt-3 aproduct-description">Washable & aesthetic, ideal for dining, living spaces & beds.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 199/ Peice</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹499</del></span></span>  <br>
                <span><b>Weight:</b> 250g/peice</span><br>
                <span><b>Size:</b> 60x16 inches</span>
            </p>
...
<div style="text-align:justify;">
    ...
    <ul>
        <li><b>Premium Quality Cotton:</b> Made from 100% pure cotton for a soft, durable, and elegant finish.</li>
        <li><b>Perfect Size:</b> Measures 60 x 16 inches, designed specifically for 4-seater dining tables and beds.</li>
        <li><b>Washable & Easy Care:</b> Machine washable and fade-resistant, ensuring long-lasting beauty and easy maintenance.</li>
        <li><b>Aesthetic Design:</b> Stunning misty blue color adds a calming touch to your dining room, living room, or restaurant décor.</li>
        <li><b>Versatile Use:</b> Ideal for dining tables, beds, coffee tables, or as decorative accents in any room.</li>
        <li><b>Stylish Protection:</b> Protects surfaces from spills and scratches while enhancing your home’s aesthetic.</li>
        <li><b>Perfect for All Occasions:</b> Suitable for everyday use, family gatherings, and special events.</li>
        <li><b>Eco-Friendly Choice:</b> Made from natural materials, contributing to a sustainable lifestyle.</li>
    </ul>
</div>
