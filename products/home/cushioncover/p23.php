...
<div class="container my-5">
    <div class="row aproduct-card" id="home_cushioncover_p23">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="../../../productimgs/home/cushioncover/p23/main.jpg" class="product-link">
                 <img src="../../../productimgs/home/cushioncover/p23/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/cushioncover/p23/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p23/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p23/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p23/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/home/cushioncover/p23/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p23/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p23/6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/home/cushioncover/p23/7.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Rich Brown Quilted Cushion Covers (Set of 2)</h2>
            <p class="mt-3 aproduct-description">Super soft silk cotton with embroidered design & zipper.<br> 
...
<div style="text-align:justify;">
    ...
    <ul>
        <li><b>Material:</b> Silk Cotton</li>
        <li><b>Perfect Size:</b> Each cover measures 15x15 inches.</li>
        <li><b>Elegant Embroidery:</b> The covers feature intricate embroidery, adding a touch of sophistication to your home decor.</li>
        <li><b>Quilted Design:</b> The quilted pattern not only enhances the visual appeal but also provides an extra layer of comfort.</li>
        <li><b>Closure Convenience:</b> Quality zipper on the back ensures easy use and removal.</li>
        <li><b>Easy Maintenance:</b> Machine washable for convenient cleaning and upkeep.</li>
    </ul>
</div>
