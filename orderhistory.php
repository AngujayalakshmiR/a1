...
if (!empty($email) && !empty($mobile)) {
    ...
    if ($result->num_rows > 0) {
        ...
        $message = "No orders found for the provided details.";
    }
...
<head>
  ...
  <style>
    ...
    table thead tr th{
        background-color: #5195a5 ;
        color: white;
    }

    /* Scroll down animation for the table */
    .table-container {
        overflow-y: auto;
    ...
    .btn-reorder, .btn-download {
        background-color: #5195a5 ;
        color: white;
    }

    .btn-reorder:hover, .btn-download:hover {
        background-color: #0a99a4;
        color: white;
    }
  ...
  <style>
    ...
    .card {
      animation: scrollDown 0.8s ease-in-out;
    }
  </style>
<style>
    .row {
...
.top-banner {
    background-color: #5195a5 ; /* Bootstrap Primary Blue */
...
.scroll-container {
  ...
  scrollbar-color: #5195a5  transparent; /* Custom scrollbar color */
...
.scroll-container::-webkit-scrollbar-thumb {
  background-color: #5195a5 ; /* Scrollbar thumb color */
...
/* Hover effect */
.btn-light:hover {
    background: linear-gradient(45deg, #5195a5 , #5dc1e6);
    color: white;
...
/* Optional: Styling for hidden product categories */
.product-grid.hidden {
    display: none;
}
.navbar{
...
.cart-modal {
    ...
    .abtn-light {
    border: 1px solid #0eb5d6;
    color: white;
    background: linear-gradient(45deg, #8dd1de, #5dc1e6);
    transition: all 0.3s ease;
    border-radius: 5px;
}
...
/* Hover effect */
.abtn-light:hover {
    background: linear-gradient(45deg, #a0d2dc, #5dc1e6);
    color: white;
    box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);
    transform: translateY(-2px); /* Slight lift effect */
}
...
.abtn-light.active {
    background: #0a8bbb; /* Darker shaded background */
    border: 1px solid #0eb5d6;
    color: white;
    ...
    <div class="container-xxl  bg-white p-0">
        ...
        <div class="nav-item d-flex align-items-center ">
                ...
                <div class="d-flex align-items-center">
                    <a  class="btn btn-light rounded-pill me-2 active">
        ...
        <div class="cart-modal" id="cart-modal">
            ...
            <div class="cart-modal-body">
                <div class="cart-empty">
                    ...
                    <p><a href="/collections/all">Shop Now</a></p>
                </div>
                <div id="cart-items"></div> <!-- Cart items will be appended here -->
            </div>
        </div>
...
<div class="container mt-5">
    <h3 class="text-center mb-4" style="color: #5195a5;">Order History</h3>
    <div class="table-container">
        <table id="orderTable" class="table table-bordered table-striped table-hover">
            <thead>
                <tr>
                    <th style="background-color:#5195a5; color: white;">S.No</th>
                    <th style="background-color:#5195a5; color: white;">Order ID</th>
                    <th style="background-color:#5195a5; color: white;">Ordered Date</th>
                    <th style="background-color:#5195a5; color: white;">Receipt</th>
                </tr>
            </thead>
            <tbody>
            <?php if (isset($message)): ?>
                <tr>
                    <td colspan="4" class="text-center"><?php echo $message; ?></td>
                </tr>
    ...
    <a href="generate_receipt.php?orderid=<?= htmlspecialchars($order['orderid']) ?>" 
       class="btn btn-primary" target="_blank">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="position-relative mx-auto" style="max-width: 400px;">
                            ...
                            <button type="button" class="btn py-2 position-absolute top-0 end-0 mt-2 me-2" style="background-color: #5195a5 ;color: white;">Enter</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Back to Top -->
        <a href="#" class="btn btn-lg  btn-lg-square back-to-top" style="background-color: #5195a5 ;color: white;"><i class="bi bi-arrow-up"></i></a>
    </div>
