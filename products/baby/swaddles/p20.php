...
<div class="container my-5">
    <div class="row aproduct-card" id="baby_swaddles_p20">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p20.php" class="product-link">
                 <img src="../../../productimgs/baby/swaddle/p20/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/baby/swaddle/p20/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                
                <img src="../../../productimgs/baby/swaddle/p20/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p20/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p20/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p20/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p20/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Combo- 1 Muslin Swaddle & 2 Face Towels</h2>
            <p class="mt-3 aproduct-description">Soft 100x100 cm swaddle with 2 gentle 40x40 washcloths.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 329/ Set </b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹799</del></span></span>  <br>
    ...
    <li><b>Special Feature:</b> Lightweight, Long Lasting, Quick Dry, Breathable</li>
    <li><b>Style:</b> Baby Blanket</li>
    <li><b>Blanket Form:</b> Swaddle</li>
    <li><b>Age Range:</b> Baby</li>
    <li><b>Product Dimensions:</b> 100L x 100W Centimeters</li>
    <li><b>Theme:</b> Animals</li>
    <li><b>Pattern:</b> Animal Print</li>
</ul>

<div style="text-align:justify;">
    <h4>About this item</h4>
    <ul>
        <li><b>Brand: BIGMOON –</b> Trusted name for high-quality baby essentials.</li>
        <li><b>Combo Pack Includes –</b> 1 Baby Shark Print Swaddle (100 cm x 100 cm) + 2 Baby Butterfly Print Washcloths (40 cm x 40 cm).</li>
        <li><b>100% Soft Malmal Fabric –</b> Made from ultra-soft and breathable malmal cotton, gentle on delicate baby skin.</li>
        <li><b>Versatile Baby Shark Swaddle –</b> Ideal for swaddling, using as a blanket, stroller cover, or play mat.</li>
        <li><b>Multi-Use Baby Butterfly Washcloths –</b> Perfect for face cleansing, burping, or maintaining hygiene.</li>
        <li><b>Super Soft & Lightweight –</b> Ensures comfort, keeps the baby dry, and provides warmth throughout the day.</li>
        <li><b>Cute & Fun Prints –</b> Adorable baby shark and butterfly designs that brighten up your baby's day.</li>
    </ul>
</div>
