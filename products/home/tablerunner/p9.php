...
<div class="container my-5">
    <div class="row aproduct-card" id="home_tablerunner_p9">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p9.php" class="product-link">
                 <img src="../../../productimgs/home/tablerunner/p9/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/tablerunner/p9/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p9/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p9/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p9/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p9/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p9/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p9/6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Sun-Drenched Striped Cotton Table Runner</h2>
            <p class="mt-3 aproduct-description">Vibrant multicolor design, perfect for dining, coffee & foyer tables.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 249/ Peice</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹599</del></span></span>  <br>
                <span><b>Weight:</b> 250g/peice</span><br>
                <span><b>Size:</b> 72x13 inches</span>
            </p>
...
<div style="text-align:justify;">
    ...
    <ul>
        <li><b>100% Pure Cotton:</b> Crafted from premium cotton for a soft, durable, and luxurious feel.</li>
        <li><b>Vibrant Multicolor Stripes:</b> Sun-drenched hues with modern variegated stripes brighten any space.</li>
        <li><b>Generous Size:</b> 72 x 13 inches, perfect for 6-seater dining tables or smaller tables.</li>
        <li><b>Versatile Use:</b> Ideal for dining, coffee, foyer tables, and more, enhancing any room’s decor.</li>
        <li><b>Durable & Fused for Strength:</b> Designed for everyday use with added durability to withstand wear.</li>
        <li><b>Easy Care:</b> Machine washable and fade-resistant for hassle-free maintenance.</li>
        <li><b>Modern Home Decor:</b> Adds a stylish touch to casual meals, festive occasions, or everyday décor.</li>
        <li><b>Perfect for Any Occasion:</b> Ideal for daily use, family gatherings, and special events.</li>
    </ul>
</div>
