...
<div class="container my-5">
    <div class="row aproduct-card" id="baby_swaddles_p11">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p11.php" class="product-link">
                 <img src="../../../productimgs/baby/swaddle/p11/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/baby/swaddle/p11/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                
                <img src="../../../productimgs/baby/swaddle/p11/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p11/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p11/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p11/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p11/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/baby/swaddle/p11/6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title"> Bamboo Cotton Muslin Swaddle</h2>
            <p class="mt-3 aproduct-description">Ultra-soft, breathable mustard yellow swaddle<br> 
    ...
    <li><b>Colour:</b> Multi Color, Yellow</li>
    ...
    <li><b>Style:</b> Modern, Turkish</li>
...
<div style="text-align:justify;">
    ...
    <li><b>Ultra Soft & Gentle:</b> Made from 100% bamboo cotton for the ultimate comfort.</li>
    <li><b>Breathable Material:</b> Keeps your baby cool and cozy, perfect for sensitive skin.</li>
    <li><b>Versatile Use:</b> Ideal for swaddling, as a towel, or a light blanket.</li>
    <li><b>Generous Size (120x120 cm):</b> 47"x47" to accommodate newborns to toddlers.</li>
    <li><b>Stylish Design:</b> Mustard yellow with charming prints, suitable for 0-18+ months.</li>
</div>
