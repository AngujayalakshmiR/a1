...
<div class="container my-5">
    <div class="row aproduct-card" id="home_cushioncover_p15">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="../../../productimgs/home/cushioncover/p15/main.jpg" class="product-link">
                 <img src="../../../productimgs/home/cushioncover/p15/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/cushioncover/p15/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p15/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p15/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p15/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/home/cushioncover/p15/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p15/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p15/6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Xmas Tree Cotton Cushion Covers (Set of 2)</h2>
            <p class="mt-3 aproduct-description">Festive decorative throw pillows with green pom-pom lace.<br> 
    ...
    <li><b>Colour:</b> Green and white</li>
...
<div style="text-align:justify;">
    ...
    <ul>
        ...
        <li><b>Perfect 18x18 Inches Size:</b> Fits most standard throw pillows for sofas, beds, and chairs.</li>
        <li><b>Easy Care & Machine Washable:</b> Retains vibrant colors and softness after multiple washes.</li>
        <li><b>Ideal for Christmas & New Year:</b> Perfect for holiday decor and creating a festive ambiance.</li>
    </ul>
</div>
