...
<div class="container my-5">
    <div class="row aproduct-card" id="home_cushioncover_p28">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="../../../productimgs/home/cushioncover/p28/main.jpg" class="product-link">
                 <img src="../../../productimgs/home/cushioncover/p28/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/cushioncover/p28/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p28/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p28/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Ivory Golden Floral Print Cushion Covers (Set of 2)</h2>
            <p class="mt-3 aproduct-description">Elegant, soft & durable with a premium finish.<br> 
...
<div style="text-align:justify;">
    ...
    <ul>
        ...
        <li><b>Machine Washable:</b> Easy to clean and maintain for long-lasting use.</li>
        <li><b>Zipper Closure:</b> Ensures easy insertion and removal of cushions while maintaining a seamless look.</li>
    </ul>
</div>
