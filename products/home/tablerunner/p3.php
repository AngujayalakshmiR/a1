...
<div class="container my-5">
    <div class="row aproduct-card" id="home_tablerunner_p3">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p3.php" class="product-link">
                 <img src="../../../productimgs/home/tablerunner/p3/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/tablerunner/p3/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p3/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p3/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p3/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p3/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Pink Blossom Cotton Table Runner</h2>
            <p class="mt-3 aproduct-description">Floral, elegant, washable dining decor.<br> 
                ...
                <span><b>Size:</b> 70x13 inches</span>
            </p>
...
<div style="text-align:justify;">
    ...
    <ul>
        <li><b>Premium Quality:</b> Crafted from 100% pure cotton for a soft, luxurious feel.</li>
        <li><b>Stylish Design:</b> Beautiful pink floral pattern adds a touch of elegance to your dining or coffee table.</li>
        <li><b>Perfect Fit:</b> Measures 70 x 13 inches, ideal for 4-seater dining tables and versatile enough for coffee tables.</li>
        <li><b>Easy Care:</b> Machine washable for effortless cleaning and maintenance, ensuring long-lasting beauty.</li>
        <li><b>Versatile Use:</b> Perfect for everyday dining, special occasions, or as a charming home decor accent.</li>
    </ul>
</div>
