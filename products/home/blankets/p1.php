...
<div class="container my-5">
    <div class="row aproduct-card" id="home_blankets_p1">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p1.php" class="product-link">
                 <img src="../../../productimgs\home\blankets\p1\main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs\home\blankets\p1\main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                
                <img src="../../../productimgs\home\blankets\p1\1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs\home\blankets\p1\2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs\home\blankets\p1\3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
...
<div style="text-align:justify;">
    ...
    <li><b>Material:</b> Made from 100% heavy pure cotton for ultimate softness and durability.</li>
    <li><b>Size:</b> Generous dimensions of 70" x 53" (177 x 134 cm) for versatile use.</li>
    <li><b>Design:</b> Reversible multicolour striped pattern with stylish fringes.</li>
    <li><b>Functionality:</b> Perfect for adding warmth and style to sofas, beds, and couches.</li>
    <li><b>Care:</b> Machine washable for easy maintenance and long-lasting color retention.</li>
    <li><b>Seasonal Use:</b> Ideal for winter, ensuring cozy comfort during cold evenings.</li>
</div>
