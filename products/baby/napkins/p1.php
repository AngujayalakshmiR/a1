...
<div class="container my-5">
    <div class="row aproduct-card" id="baby_napkins_p1">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p1.php" class="product-link">
                 <img src="../../../productimgs/baby/napkin/p1/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/baby/napkin/p1/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">

                <img src="../../../productimgs/baby/napkin/p1/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/napkin/p1/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/napkin/p1/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/napkin/p1/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/napkin/p1/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/napkin/p1/6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <div class="col-md-6 " >
            ...
            <ul>
                ...
                <li><b>Number of Items:</b> 6</li>
                <li><b>Style:</b> Turkish</li>
                <li><b>Pattern:</b> Animal Print, Sky Print, Vehicle Print</li>
                <li><b>Special Feature:</b> Skin Friendly, Super Absorbent, Lightweight, Quick Dry, Super Soft</li>
            ...
            <div style="text-align:justify;">
                ...
                <li><b>Premium Organic Muslin:</b> Made from 100% organic cotton, ideal for sensitive baby skin.</li>
                <li><b>Extra Soft & Absorbent:</b> Provides ultimate comfort and quick absorption for mess-free use.</li>
                <li><b>Adorable Prints:</b> Features cute animal, sky, and vehicle designs, making care routines enjoyable.</li>
                <li><b>Versatile Use:</b> Perfect for face towels, washcloths, and napkins, measuring 16x16 inches.</li>
                <li><b>Eco-Friendly & Reusable:</b> Durable, washable, and reusable, promoting sustainable parenting.</li>
            </div>
