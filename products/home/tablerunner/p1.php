...
<div class="container my-5">
    <div class="row aproduct-card" id="home_tablerunner_p1">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p1.php" class="product-link">
                 <img src="../../../productimgs/home/tablerunner/p1/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/tablerunner/p1/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p1/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p1/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p1/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p1/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablerunner/p1/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Beige Striped Cotton Table Runner</h2>
            <p class="mt-3 aproduct-description">Elegant, washable, durable dining decor.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 229/ Peice</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹599</del></span></span>  <br>
                <span><b>Weight:</b> 250g/peice</span><br>
                <span><b>Size:</b> 72x12 inches</span>
            </p>
...
<div style="text-align:justify;">
    ...
    <ul>
        <li><b>Premium 100% Cotton Fabric:</b> Made from pure, high-quality cotton for lasting softness and durability, providing a luxurious feel.</li>
        <li><b>Elegant Beige Striped Design:</b> The neutral beige stripes complement any interior style, perfect for modern and traditional decor.</li>
        <li><b>Ideal Size for 6-Seater Tables:</b> Measuring 72 x 12 inches, this table runner is designed to fit most dining tables, coffee tables, and foyer tables.</li>
        <li><b>Versatile Use for Multiple Occasions:</b> Perfect for daily use, festive gatherings, holiday meals, or as a decorative accent for any table.</li>
        <li><b>Machine Washable for Easy Care:</b> Convenient to clean and maintain, just toss it in the wash to keep it looking fresh after every use.</li>
        <li><b>Perfect for Dining & Coffee Tables:</b> A must-have for your dining room, living room, or restaurant to add charm and style to any setting.</li>
        <li><b>Durable & Non-Slip:</b> Thick and well-constructed, this table runner stays securely in place, even during meals or gatherings.</li>
        <li><b>Festive Home Decor:</b> A great addition to your holiday table settings or to enhance your home decor throughout the year.</li>
        <li><b>Timeless Gift Idea:</b> Makes a thoughtful gift for weddings, housewarmings, or for those who love to entertain.</li>
    </ul>
</div>
