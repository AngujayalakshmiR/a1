...
<div class="container my-5">
    <div class="row aproduct-card" id="baby_swaddles_p19">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p19.php" class="product-link">
                 <img src="../../../productimgs/baby/swaddle/p19/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/baby/swaddle/p19/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                
                <img src="../../../productimgs/baby/swaddle/p19/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p19/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p19/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p19/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p19/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p19/6.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/baby/swaddle/p19/7.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Towel Set–Strawberry & Shark (Pack of 2)</h2>
            <p class="mt-3 aproduct-description">Ultra-soft 75x140 cm towel with Strawberry & Shark prints.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 499/ Set </b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹999</del></span></span>  <br>
    ...
    <li><b>Towel Form Type:</b> Bath Towel</li>
    <li><b>Age Range:</b> Baby, Toddler</li>
    <li><b>Material:</b> Cotton</li>
    <li><b>Product Dimensions:</b> 140L x 75W Centimeters</li>
    <li><b>Number of Items:</b> 2</li>
    <li><b>Style:</b> Modern</li>
    <li><b>Pattern:</b> Strawberry, Shark</li>
    <li><b>Special Features:</b> Skin Friendly, Super Absorbent, Super Soft, Durable, Breathable</li>
</ul>

<div style="text-align:justify;">
    <h4>About this item</h4>
    <ul>
        <li><b>Brand: BIGMOON –</b> Trusted brand for premium baby essentials.</li>
        <li><b>100% Organic Muslin Cotton –</b> Made from high-quality organic muslin, super gentle on newborn skin.</li>
        <li><b>Highly Absorbent & Quick-Drying –</b> Absorbs moisture efficiently and dries quickly to keep your baby comfortable.</li>
        <li><b>Multipurpose Use –</b> Ideal for bath time, swaddling, burping, or as a lightweight blanket.</li>
        <li><b>Hypoallergenic & Chemical-Free –</b> Designed to be safe for sensitive baby skin, free from harmful chemicals.</li>
        <li><b>Machine Washable & Long-Lasting –</b> Softens with every wash, ensuring durability and long-term use.</li>
        <li><b>Easy to Carry –</b> Lightweight and travel-friendly for everyday convenience.</li>
    </ul>
</div>
