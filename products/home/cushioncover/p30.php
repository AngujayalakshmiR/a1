...
<div class="container my-5">
    <div class="row aproduct-card" id="home_cushioncover_p30">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="../../../productimgs/home/cushioncover/p30/main.jpg" class="product-link">
                 <img src="../../../productimgs/home/cushioncover/p30/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/cushioncover/p30/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p30/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p30/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/home/cushioncover/p30/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p30/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/home/cushioncover/p30/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Multi-Color Cotton Floral Cushion Covers (Set of 5)</h2>
            <p class="mt-3 aproduct-description">Soft, durable, and stylish pillow covers for home décor.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 399/ Pack</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹799</del></span></span>  <br>
...
<div style="text-align:justify;">
    ...
    <ul>
        <li><b>Perfect Size & Fit:</b> Measuring 18x18 inches (45x45 cm), these covers fit most standard cushions for sofas, couches, and beds.</li>
        <li><b>Multi-Purpose Use:</b> Ideal for sofa cushions, couch pillows, bedroom decor, festive home styling, and seasonal décor.</li>
        <li><b>Durable & Long-Lasting:</b> High-quality stitching ensures durability, making them perfect for everyday use.</li>
        <li><b>Festive & Everyday Decor:</b> Elevate your home decor for festivals, special occasions, or simply to refresh your interiors.</li>
        <li><b>Easy to Maintain:</b> Machine washable, fade-resistant fabric keeps the cushion covers looking fresh and vibrant.</li>
        <li><b>Perfect Gift Choice:</b> A thoughtful gift for housewarming, birthdays, weddings, and festive occasions.</li>
    </ul>
</div>
