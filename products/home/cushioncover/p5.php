...
<div class="container my-5">
    <div class="row aproduct-card" id="home_cushioncover_p5">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="../../../productimgs/home/cushioncover/p5/main.jpg" class="product-link">
                 <img src="../../../productimgs/home/cushioncover/p5/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/cushioncover/p5/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p5/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p5/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p5/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p5/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/home/cushioncover/p5/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Golden Quilted Cushion Covers (Pack of 2)</h2>
            <p class="mt-3 aproduct-description">Super soft silk cotton with embroidery, hidden zipper closure.<br> 
    ...
    <li><b>Colour:</b> Gold</li>
    <li><b>Product Dimensions:</b> 38.1L x 38.1W Centimeters</li>
    <li><b>Style:</b> Luxurious Elegant</li>
</ul>
...
<div style="text-align:justify;">
    ...
    <ul>
        ...
        <li><b>Cushion Cover Colour:</b> Golden</li>
