...
<div class="container my-5">
    <div class="row aproduct-card" id="home_tablecloth_p4">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p4.php" class="product-link">
                 <img src="../../../productimgs/home/tablecloth/p4/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/tablecloth/p4/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablecloth/p4/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablecloth/p4/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablecloth/p4/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Blue Cotton Dining Tablecloth</h2>
            <p class="mt-3 aproduct-description">Lightweight, durable, 6-seater table cover.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 599/ Peice</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹999</del></span></span>  <br>
