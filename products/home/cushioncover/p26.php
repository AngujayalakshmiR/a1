...
<div class="container my-5">
    <div class="row aproduct-card" id="home_cushioncover_p26">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="../../../productimgs/home/cushioncover/p26/main.jpg" class="product-link">
                 <img src="../../../productimgs/home/cushioncover/p26/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/cushioncover/p26/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p26/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p26/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p26/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                     <img src="../../../productimgs/home/cushioncover/p26/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/cushioncover/p26/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Beige Quilted Cushion Covers (Set of 2)</h2>
            <p class="mt-3 aproduct-description">Soft silk with embroidered design & hidden zipper.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 249/ Pack</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹399</del></span></span>  <br>
    ...
    <li><b>Product Dimensions:</b> 35.6L x 35.6W Centimeters</li>
...
<div style="text-align:justify;">
    ...
    <ul>
        <li><b>Elegant Aesthetic:</b> Soft silk cushion covers bring a touch of luxury and sophistication to any space, enhancing the overall decor with their natural sheen and smooth texture. Size: 14 x 14 inches.</li>
