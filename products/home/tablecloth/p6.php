...
<div class="container my-5">
    <div class="row aproduct-card" id="home_tablecloth_p6">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p6.php" class="product-link">
                 <img src="../../../productimgs/home/tablecloth/p6/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/tablecloth/p6/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablecloth/p6/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablecloth/p6/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Red & Black Checkered Tablecloth</h2>
            <p class="mt-3 aproduct-description">Elegant, pure cotton 6-seater dining cover.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 799/ Peice</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹999</del></span></span>  <br>
    ...
    <li><b>Recommended Uses For Product:</b> Table</li>
    <li><b>Pattern:</b> Checkered</li>
    <li><b>Style:</b> Durability</li>
    <li><b>Occasion:</b> Birthday</li>
    <li><b>Special Feature:</b> Reversible</li>
</ul>
<div style="text-align:justify;">
    <h4>About this item</h4>
    <ul>
        <li><b>Product Name:</b> Table Cloth / Table Cover</li>
        <li><b>Size:</b> Ideal Size for 6-Seater Tables 60*90 Inches</li>
        <li><b>Material:</b> Premium Cotton Quality - Crafted from 100% fine cotton fabric</li>
        <li><b>Pattern:</b> Red and Black Checked Pattern</li>
        <li><b>Shape:</b> Rectangular</li>
    </ul>
</div>
