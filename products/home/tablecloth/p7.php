...
<div class="container my-5">
    <div class="row aproduct-card" id="home_tablecloth_p7">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p7.php" class="product-link">
                 <img src="../../../productimgs/home/tablecloth/p7/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/tablecloth/p7/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablecloth/p7/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablecloth/p7/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <!-- <img src="../../../productimgs/home/tablecloth/p5/3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;"> -->
                <!-- <img src="../../../productimgs/home/tablecloth/p4/4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;"> -->
                <!-- <img src="../../../productimgs/home/tablecloth/p4/5.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;"> -->
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Grey Cotton Dining Tablecloth</h2>
            <p class="mt-3 aproduct-description">Lightweight, durable, 6-seater table cover.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 299/ Peice</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹1299</del></span></span>  <br>
                <span><b>Weight:</b> 1000g/peice</span><br>
                <span><b>Size:</b> 60x90 inches</span>
            </p>
            ...
            <br><br>
            <ul>
    <li><b>Colour:</b> Grey</li>
    <li><b>Material:</b> Cotton</li>
    <li><b>Product Dimensions:</b> 2.24L x 1.52W Meters</li>
    <li><b>Shape:</b> Rectangular</li>
    <li><b>Recommended Uses For Product:</b> Dining Table</li>
    <li><b>Pattern:</b> Solid</li>
    <li><b>Style:</b> Modern</li>
    <li><b>Occasion:</b> Birthday</li>
    <li><b>Special Feature:</b> Lightweight, Fade Resistant</li>
</ul>

<div style="text-align:justify;">
    <h4>About this item</h4>
    <ul>
        <li><b>Durable and Long-lasting:</b> Cotton tablecloths are known for their durability, withstanding regular use and multiple washes without losing their texture or shape.</li>
        <li><b>Size:</b> 60 inches x 90 inches, ideal for most 6-seater dining tables.</li>
        <li><b>Soft Texture:</b> Cotton provides a comfortable, soft surface for dining, enhancing the overall experience.</li>
        <li><b>Breathability:</b> The natural breathability of cotton makes it ideal for year-round use, particularly in warmer climates where it helps to maintain a cool surface.</li>
        <li><b>Absorbency:</b> Highly absorbent, effectively containing spills and preventing them from seeping through to the table underneath.</li>
        <li><b>Temperature Regulation:</b> Cotton's natural properties help regulate temperature, making it a comfortable choice for both summer and winter.</li>
        <li><b>Protection and Maintenance:</b> 
            <ul>
                <li><b>Protects the Table:</b> Provides a protective layer that guards your dining table against spills, scratches, and heat damage, extending the life of your furniture.</li>
                <li><b>Easy to Clean:</b> Most cotton tablecloths are machine washable, making them easy to clean and maintain.</li>
            </ul>
        </li>
        <li><b>Versatility and Use Cases:</b> 
            <ul>
                <li><b>Everyday Use:</b> Ideal for daily meals, offering a practical yet stylish surface for your dining needs.</li>
                <li><b>Special Occasions:</b> Suitable for formal dinners, holiday gatherings, and special events, adding a touch of sophistication and elegance.</li>
            </ul>
        </li>
    </ul>
</div>
