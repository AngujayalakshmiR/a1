...
<div class="container my-5">
    <div class="row aproduct-card" id="home_placemat_p1">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p1.php" class="product-link">
                 <img src="../../../productimgs\home\placemat\p1\main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs\home\placemat\p1\main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                
                <img src="../../../productimgs\home\placemat\p1\1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs\home\placemat\p1\2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <img src="../../../productimgs\home\placemat\p1\3.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
                <!-- <img src="../../../productimgs\home\blankets\p1\4.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Red Cotton Placemats</h2>
            <p class="mt-3 aproduct-description">Soft, durable, machine-washable dining set(Set of 4).<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 199/ Piece </b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹499</del></span></span>  <br>
                <span><b>Weight:</b> 1200g/peice</span><br>
                <span><b>Size:</b> 19x14 inches</span>
            </p>
    ...
    <li><b>Size:</b> Set of 4</li>
    <li><b>Occasion:</b> Christmas, New Year, Birthday</li>
</ul>


<div style="text-align:justify;">
    <h4>About this item</h4>
    <li><b>Colour:</b> Red & Sandal</li>
    <li><b>Size:</b> Generous size of 14x19 inches (48x35 cm)</li>
    ...
    <li><b>Set of 4, 6, or 8:</b> High-quality placemats in vibrant red & sandal, adding a pop of color to your dining space.</li>
