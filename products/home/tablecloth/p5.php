...
<div class="container my-5">
    <div class="row aproduct-card" id="home_tablecloth_p5">
        <!-- Left Side: Images -->
        <div class="col-md-6">
            <div>
                 <a href="p5.php" class="product-link">
                 <img src="../../../productimgs/home/tablecloth/p5/main.jpg"alt="Product Preview" id="bigImage" class="aproduct-image product-image-preview">
                 </a>
            </div>
            <div class="mt-3 product-thumbnails  gap-2">
            <img src="../../../productimgs/home/tablecloth/p5/main.jpg" 
            alt="Thumbnail" onclick="changeImage(this)" class="active" style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablecloth/p5/1.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)"  style="width: 70px;height: 70px;">
                <img src="../../../productimgs/home/tablecloth/p5/2.jpg" 
                     alt="Thumbnail" onclick="changeImage(this)" style="width: 70px;height: 70px;">
        ...
        <!-- Right Side: Details -->
        <div class="col-md-6 " >
            <h2 class="aproduct-title">Yellow & Blue Cotton Tablecloth</h2>
            <p class="mt-3 aproduct-description">Soft, durable, 6-seater rectangular cover.<br> 
                <span class="text-danger" style="font-size: 24px;"><b>₹ 599/ Peice</b> <span class="ms-3" style="color:#0eb5d6;font-size: 18px;"><del>₹799</del></span></span>  <br>
    ...
    <li><b>Occasion:</b> Housewarming</li>
    <li><b>Special Feature:</b> Heat Resistant</li>
...
<div style="text-align:justify;">
    ...
    <ul>
        <li><b>Material:</b> Cotton</li>
        <li><b>Size:</b> 90 * 60 inches / 228 * 152 CM</li>
        <li><b>Pattern:</b> Plaid</li>
        <li><b>Shape:</b> Rectangular</li>
    </ul>
</div>
